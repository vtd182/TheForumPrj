...
\newcommand{\tagMucDo}[1]{%
  \tcbox[
    on line,
    colback=ForumGold!20,
    colframe=ForumGold,
    boxrule=0.4pt,
    arc=2pt,
    left=3pt, right=3pt, top=1pt, bottom=1pt,
    fontupper=\sffamily\footnotesize\bfseries
  ]{\textcolor{ForumGold!80!black}{#1}}%
}

\newcommand{\mucDoTB}{\tagMucDo{Trung bình}}
\newcommand{\mucDoKho}{\tagMucDo{Khó}}
\newcommand{\mucDoRatKho}{\tagMucDo{Rất khó}}
