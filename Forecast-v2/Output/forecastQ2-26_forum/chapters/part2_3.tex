...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{low-level availability} & & n phr & & the ongoing readiness to help without making an occasion of it | sự sẵn sàng giúp đỡ âm thầm \\ \hline
\textbf{social currency} & n phr & /ˈsəʊ.ʃəl ˈkʌr.ən.si/ & influence or favour gained through social interactions & vốn xã hội, uy tín giao tiếp \\ \hline
\textbf{structural glue} & & n phr & & something that holds a group or system together | chất kết dính, yếu tố gắn kết \\ \hline
\textbf{humane} & adj & /hjuːˈmeɪn/ & showing compassion and respect for others & nhân văn, có tình người \\ \hline
\textbf{performative} & adj & /pəˈfɔː.mə.tɪv/ & done to create an impression rather than from genuine feeling & mang tính trình diễn \\ \hline
\textbf{instinct} & n & /ˈɪn.stɪŋkt/ & a natural ability to sense or do something without thinking & bản năng \\ \hline
\textbf{initiate} & v & /ɪˈnɪʃ.i.eɪt/ & to start or begin something & khởi xướng, chủ động bắt đầu \\ \hline
\textbf{replicate} & v & /ˈrep.lɪ.keɪt/ & to copy or reproduce something & tái tạo lại, bắt chước \\ \hline
\textbf{in conflict with} & phr & /ɪn ˈkɒn.flɪkt wɪð/ & having a disagreement or problem with someone & có mâu thuẫn với \\ \hline
\textbf{modelled} & v & /ˈmɒd.əld/ & demonstrated a behaviour for others to follow & làm gương, thể hiện qua hành động \\ \hline
\end{tabularx}
\end{center}
...
<br>
- \textbf{career narrative} (n phr) (/kəˈrɪər ˈnær.ə.tɪv/): the story a professional tells about their career path | câu chuyện sự nghiệp
- \textbf{asymmetric exposure} (n phr) (/ˌeɪ.sɪˈmet.rɪk ɪkˈspəʊ.ʒər/): an imbalanced reliance on one source of support | sự phụ thuộc mất cân bằng
- \textbf{power differential} (n phr) (/ˈpaʊ.ər ˌdɪf.əˈren.ʃəl/): the difference in authority between two people | sự chênh lệch quyền lực
- \textbf{compound} (v) (/ˈkɒm.paʊnd/): to make a problem worse by adding to it | tích lũy, làm trầm trọng hơn
- \textbf{normalise} (v) (/ˈnɔː.mə.laɪz/): to make something seem acceptable or standard | bình thường hóa
- \textbf{self-sufficiency} (n) (/ˌself.səˈfɪʃ.ən.si/): the ability to provide for oneself without help | sự tự chủ, tự lực
- \textbf{socioeconomic inequality} (n phr) (/ˌsəʊ.si.əʊˌiː.kəˈnɒm.ɪk ɪnˈiː.kwəl.ɪ.ti/): unequal access to resources based on social and economic status | bất bình đẳng kinh tế xã hội
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{developmental significance} & n phr & /ˌdev.əl.əpˈmen.təl sɪɡˈnɪf.ɪ.kəns/ & the importance of an experience in shaping a person's growth & tầm quan trọng phát triển \\ \hline
\textbf{delayed gratification} & n phr & /dɪˈleɪd ˌɡræt.ɪ.fɪˈkeɪ.ʃən/ & the ability to resist immediate reward for a greater future benefit & sự hài lòng trì hoãn \\ \hline
\textbf{care work} & n phr & /keər wɜːk/ & unpaid labour that involves looking after others or a household & công việc chăm sóc (thường không được trả công) \\ \hline
\end{tabularx}
\end{center}
...
The occasion was a corporate gala dinner that my company hosted about two years ago — the kind of event that is assembled quickly and where the entertainment choices are made by people whose priorities are catering costs rather than musical coherence.

I attended because it was a mandatory professional engagement, and I went with my direct team. The music that had been arranged was a live band playing a continuous set of Vietnamese pop covers — technically proficient, polished enough, but delivered at a volume and energy level that was wildly mismatched with the purpose of the event, which was supposed to be a formal appreciation dinner with meaningful table conversations.

What I found frustrating was not the music itself but the environmental effect it produced. Every conversation at our table required effort that should not have been necessary. People were leaning forward, cupping their ears, and eventually giving up and defaulting to polite silence or gestures. The music, which was presumably intended to create a festive atmosphere, had the functional effect of atomising the room — putting each table inside its own acoustic bubble and making the collective experience feel fragmented rather than celebratory.
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{EDM} & n & /ˌiː.diːˈem/ & electronic dance music & nhạc điện tử để nhảy \\ \hline
\textbf{disorienting} & adj & /ˌdɪs.ɔː.riˈen.tɪŋ/ & causing confusion about one's surroundings or situation & gây mất phương hướng \\ \hline
\textbf{monotonous} & adj & /məˈnɒt.ə.nəs/ & lacking variation and therefore boring & đơn điệu, nhàm chán \\ \hline
\textbf{gala dinner} & n phr & /ˈɡɑː.lə ˈdɪn.ər/ & a formal celebratory meal, often for an organisation & tiệc gala \\ \hline
\textbf{tonally mismatched} & adj phr & /ˈtəʊ.nə.li ˈmɪs.mætʃt/ & having a mood or tone that does not fit the occasion & không phù hợp về không khí, giai điệu \\ \hline
\textbf{atomise} & v & /ˈæt.ə.maɪz/ & to break something into isolated fragments & chia cắt, làm phân tán \\ \hline
\textbf{acoustic bubble} & n phr & /əˈkuː.stɪk ˈbʌb.əl/ & a zone isolated from others by sound & bong bóng âm thanh \\ \hline
\textbf{mandatory} & adj & /ˈmæn.də.tər.i/ & required by rules or obligation & bắt buộc \\ \hline
\textbf{relentlessness} & n & /rɪˈlent.ləs.nəs/ & the quality of being continuous without pause & sự không ngừng nghỉ \\ \hline
\textbf{coherence} & n & /kəʊˈhɪər.əns/ & logical consistency and harmony & sự nhất quán, tính hài hòa \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{dissociation effect} & n phr & /ˌdɪs.əʊ.siˈeɪ.ʃən ɪˈfekt/ & music's ability to divert attention away from physical discomfort & hiệu ứng phân tán chú ý \\ \hline
\textbf{ergogenic} & adj & /ˌɜː.dʒəˈdʒen.ɪk/ & enhancing physical performance & tăng cường hiệu suất thể chất \\ \hline
\textbf{motivational regulation} & n phr & /ˌməʊ.tɪ.veɪ.ʃən.əl ˌreɡ.jʊˈleɪ.ʃən/ & managing one's emotions and drive to perform & điều tiết động lực \\ \hline
\textbf{acoustic quality} & n phr & /əˈkuː.stɪk ˈkwɒl.ɪ.ti/ & the standard of sound in a space & chất lượng âm thanh \\ \hline
\textbf{irreproducibility} & n & /ˌɪr.ɪ.prəˌdjuː.sɪˈbɪl.ɪ.ti/ & the quality of being unable to be replicated exactly & tính không thể tái tạo \\ \hline
\textbf{phonological awareness} & n phr & /ˌfɒn.əˈlɒdʒ.ɪ.kəl əˈweər.nəs/ & sensitivity to the sounds of language & nhận thức về âm vị học \\ \hline
\textbf{curated} & adj & /kjʊəˈreɪ.tɪd/ & carefully selected and organised & được chọn lọc kỹ càng \\ \hline
\textbf{attenuated} & adj & /əˈten.ju.eɪ.tɪd/ & reduced in strength or effect & bị giảm bớt, suy yếu \\ \hline
\textbf{synchronisation} & n & /ˌsɪŋ.krə.naɪˈzeɪ.ʃən/ & the coordination of movements or actions to a rhythm & sự đồng bộ hóa \\ \hline
\textbf{associative resonance} & n phr & /əˈsəʊ.ʃə.tɪv ˈrez.ə.nəns/ & the emotional power of music due to memories it triggers & sự cộng hưởng liên kết ký ức \\ \hline
\end{tabularx}
\end{center}
...
The person I want to describe is a former colleague named An, who worked in client services at my company but was teaching himself Japanese in the margins of his regular working life — during commutes, lunch breaks, and the hour before sleep each night.

He had no formal instruction at any point. He used a combination of spaced repetition flashcard apps for vocabulary, shadowing recordings of native speakers for pronunciation, and parallel reading of Japanese novels with English translations for grammar acquisition. Within about two and a half years of starting this regime, he passed the JLPT N3 — the intermediate level of the official Japanese proficiency test — on his first attempt.

What struck me was not just the outcome but the system he had built around it. He was not relying on willpower or enthusiasm; he had engineered a set of habits and constraints that made the daily effort nearly automatic. He would tell you, if you asked, that a classroom could have provided him with structure and social accountability that self-study lacks — but that for someone with an irregular schedule and a specific learning pace, the flexibility of autonomous study was ultimately more efficient than any course he could have enrolled in.
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{digital audio workstation} & n phr & /ˈdɪdʒ.ɪ.təl ˈɔː.di.əʊ ˈwɜːk.steɪ.ʃən/ & software used to record, edit, and produce audio & phần mềm sản xuất âm nhạc (DAW) \\ \hline
\textbf{aesthetic framework} & n phr & /esˈθet.ɪk ˈfreɪm.wɜːk/ & a set of ideas shaping one's sense of beauty and style & khung thẩm mỹ cá nhân \\ \hline
\textbf{spaced repetition} & n phr & /speɪst ˌrep.ɪˈtɪʃ.ən/ & a learning technique using increasing intervals to memorise information & lặp lại ngắt quãng (kỹ thuật học) \\ \hline
\textbf{shadowing} & n & /ˈʃæd.əʊ.ɪŋ/ & mimicking a recording of a speaker to improve pronunciation & kỹ thuật bắt chước giọng nói \\ \hline
\textbf{metacognitive awareness} & n phr & /ˌmet.ə.kɒɡˈnɪ.tɪv əˈweər.nəs/ & the ability to think about and understand one's own learning process & nhận thức về quá trình tư duy của bản thân \\ \hline
\textbf{autonomous study} & n phr & /ɔːˈtɒn.ə.məs ˈstʌd.i/ & self-directed learning without external supervision & học tự chủ \\ \hline
\textbf{social accountability} & n phr & /ˈsəʊ.ʃəl əˌkaʊn.tə.ˈbɪl.ɪ.ti/ & being responsible to others for one's actions or progress & trách nhiệm giải trình với người khác \\ \hline
\textbf{deliberate} & adj & /dɪˈlɪb.ər.ɪt/ & done consciously and intentionally & có chủ đích, được suy tính kỹ \\ \hline
\textbf{JLPT} & n & /ˌdʒeɪ.el.piːˈtiː/ & Japanese Language Proficiency Test & bài kiểm tra năng lực tiếng Nhật \\ \hline
\textbf{hybrid} & adj & /ˈhaɪ.brɪd/ & combining two different elements or approaches & kết hợp, lai ghép \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{half-life of knowledge} & & n phr & & the time before a body of knowledge becomes significantly outdated | vòng đời tri thức \\ \hline
\textbf{learning agility} & n phr & /ˈlɜː.nɪŋ əˈdʒɪl.ɪ.ti/ & the ability to quickly acquire and apply new skills & sự linh hoạt học hỏi \\ \hline
\textbf{T-shaped skill profile} & & n phr & & depth in one area plus breadth across several others | kỹ năng hình chữ T \\ \hline
\textbf{neuroplasticity} & n & /ˌnjʊər.əʊ.plæˈstɪs.ɪ.ti/ & the brain's ability to reorganise and form new connections & tính dẻo dai thần kinh \\ \hline
\textbf{passive transmission} & n phr & /ˈpæs.ɪv trænsˈmɪʃ.ən/ & one-way delivery of information without active student engagement & truyền đạt thụ động \\ \hline
\textbf{productive struggle} & & n phr & & the process of working through difficulty in a way that promotes learning | đấu tranh có ích trong học tập \\ \hline
\textbf{credential portfolio} & n phr & /krɪˈden.ʃəl pɔːtˈfəʊ.li.əʊ/ & a collection of qualifications and certifications & hồ sơ bằng cấp \\ \hline
\textbf{human capital} & n phr & /ˈhjuː.mən ˈkæp.ɪ.təl/ & the skills, knowledge, and experience of a workforce & vốn con người \\ \hline
\textbf{insularity} & n & /ˌɪn.sjʊˈlær.ɪ.ti/ & the tendency to be closed off from outside ideas & tính cục bộ, khép kín \\ \hline
\textbf{deliberate depth-building} & & n phr & & intentionally focusing effort on gaining deep expertise | xây dựng chiều sâu có chủ đích \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{e-ink} & n & /ˈiː.ɪŋk/ & a display technology that mimics the look of printed ink & màn hình mực điện tử \\ \hline
\textbf{backlight glare} & n phr & /ˈbæk.laɪt ɡleər/ & uncomfortable brightness from a screen's background light & ánh sáng chói từ màn hình \\ \hline
\textbf{single-purpose device} & & n phr & & a gadget designed for one specific function | thiết bị chuyên dụng một chức năng \\ \hline
\textbf{PM2.5} & n & /ˌpiː.emˈtuː.pɔɪnt.faɪv/ & fine particulate matter harmful to human health & bụi mịn PM2.5 \\ \hline
\textbf{VOC} & n & /ˌviː.əʊˈsiː/ & volatile organic compound; chemical vapour that can affect air quality & hợp chất hữu cơ dễ bay hơi \\ \hline
\textbf{cognitive performance} & n phr & /ˈkɒɡ.nɪ.tɪv pəˈfɔː.məns/ & the quality of mental processes like thinking and memory & hiệu suất nhận thức \\ \hline
\textbf{actionable} & adj & /ˈæk.ʃən.ə.bəl/ & capable of being acted upon; practically useful & có thể hành động dựa trên đó \\ \hline
\textbf{ambient} & adj & /ˈæm.bi.ənt/ & relating to the surrounding environment & xung quanh, môi trường xung quanh \\ \hline
\textbf{annotation} & n & /ˌæn.əˈteɪ.ʃən/ & notes or comments added to a text & chú thích, ghi chú trong văn bản \\ \hline
\textbf{configuration} & n & /kənˌfɪɡ.jʊˈreɪ.ʃən/ & the arrangement of parts in a system; a product variant & cấu hình, phiên bản cấu hình \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{ambient computing} & n phr & /ˈæm.bi.ənt kəmˈpjuː.tɪŋ/ & technology integrated seamlessly into the environment & máy tính môi trường xung quanh \\ \hline
\textbf{algorithmic opacity} & n phr & /ˌæl.ɡəˈrɪð.mɪk əʊˈpæs.ɪ.ti/ & the difficulty of understanding how an algorithm makes decisions & sự không minh bạch của thuật toán \\ \hline
\textbf{attention economy} & n phr & /əˈten.ʃən ɪˈkɒn.ə.mi/ & a model treating human attention as a scarce resource & nền kinh tế chú ý \\ \hline
\textbf{asynchronous} & adj & /eɪˈsɪŋ.krə.nəs/ & not happening at the same time; communication where responses are delayed & không đồng bộ \\ \hline
\textbf{attentional fragmentation} & & n phr & & the breakdown of sustained focus caused by multitasking habits | sự phân mảnh chú ý \\ \hline
\textbf{oral literacy} & n phr & /ˈɔː.rəl ˈlɪt.ər.ə.si/ & the ability to communicate effectively through spoken language & năng lực giao tiếp miệng \\ \hline
\textbf{curated self-presentation} & & n phr & & the deliberate management of one's image for others | tự trình bày hình ảnh được chọn lọc \\ \hline
\textbf{inhibition effect} & n phr & /ˌɪn.hɪˈbɪʃ.ən ɪˈfekt/ & reduced social restraint in online contexts & hiệu ứng giảm ức chế xã hội \\ \hline
\textbf{involuntarity} & n & /ɪnˌvɒl.ənˈtær.ɪ.ti/ & the quality of not being chosen or controlled & tính không chủ động lựa chọn \\ \hline
\textbf{permeability} & n & /ˌpɜː.mi.əˈbɪl.ɪ.ti/ & the degree to which something can be penetrated or crossed & tính thẩm thấu, dễ xâm nhập \\ \hline
\end{tabularx}
\end{center}
...
To reach that kind of role meaningfully, I would need to deepen my expertise in impact evaluation methodologies, build a more credible profile in the social sector, and develop the network of clients and collaborators without which independent consulting is not viable.
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{UX research} & n phr & /ˌjuːˈeks ˈrɪ.sɜːtʃ/ & user experience research; studying how people interact with products & nghiên cứu trải nghiệm người dùng \\ \hline
\textbf{user-centred} & adj & /ˈjuː.zər ˈsen.təd/ & designed with the needs of users as the primary focus & lấy người dùng làm trung tâm \\ \hline
\textbf{theory of change} & & n phr & & a model explaining how an organisation's activities lead to desired outcomes | lý thuyết thay đổi (mô hình logic) \\ \hline
\textbf{impact evaluation} & n phr & /ˈɪm.pækt ɪˌvæl.juˈeɪ.ʃən/ & measuring the effects of a programme or intervention & đánh giá tác động \\ \hline
\textbf{resource allocation} & n phr & /rɪˈsɔːs ˌæl.əˈkeɪ.ʃən/ & deciding how to distribute available resources among competing needs & phân bổ nguồn lực \\ \hline
\textbf{social enterprise} & n phr & /ˈsəʊ.ʃəl ˈen.tə.praɪz/ & a business that prioritises social goals over profit & doanh nghiệp xã hội \\ \hline
\textbf{diagnostic} & adj & /ˌdaɪ.əɡˈnɒs.tɪk/ & relating to identifying the nature of a problem & mang tính chẩn đoán, xác định vấn đề \\ \hline
\textbf{portfolio} & n & /pɔːtˈfəʊ.li.əʊ/ & a collection of work samples showing one's skills & hồ sơ năng lực, danh mục công việc \\ \hline
\textbf{viable} & adj & /ˈvaɪ.ə.bəl/ & capable of working successfully & khả thi \\ \hline
\textbf{niche} & n & /niːʃ/ & a specialised area of a market or field & lĩnh vực chuyên biệt, ngách \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{theory of change} & & n phr & & how activities are expected to lead to outcomes | lý thuyết thay đổi \\ \hline
\textbf{intrinsic motivation} & n phr & /ɪnˈtrɪn.zɪk ˌməʊ.tɪˈveɪ.ʃən/ & drive that comes from within, not from external rewards & động lực nội tại \\ \hline
\textbf{cultural salience} & n phr & /ˈkʌl.tʃər.əl ˈseɪ.li.əns/ & the degree to which something stands out in a culture & mức độ nổi bật trong văn hóa \\ \hline
\textbf{labour market} & n phr & /ˈleɪ.bər ˈmɑː.kɪt/ & the supply and demand for employment & thị trường lao động \\ \hline
\textbf{occupational psychology} & n phr & /ˌɒk.jʊˈpeɪ.ʃən.əl saɪˈkɒl.ə.dʒi/ & the study of human behaviour in professional settings & tâm lý học nghề nghiệp \\ \hline
\textbf{prestige} & n & /presˈtiːʒ/ & widespread respect and admiration for a profession or person & uy tín, danh giá \\ \hline
\textbf{attrition} & n & /əˈtrɪʃ.ən/ & the gradual reduction of a workforce through resignation or retirement & tỷ lệ nghỉ việc, sự hao mòn nhân lực \\ \hline
\textbf{supply chain} & n phr & /ˈsʌp.laɪ tʃeɪn/ & the network of businesses involved in producing and delivering a product & chuỗi cung ứng \\ \hline
\textbf{cohort} & n & /ˈkəʊ.hɔːt/ & a group sharing a particular characteristic, often age & nhóm cùng thế hệ \\ \hline
\textbf{vocational} & adj & /vəʊˈkeɪ.ʃən.əl/ & relating to practical skills for a specific job or trade & hướng nghiệp, dạy nghề \\ \hline
\end{tabularx}
\end{center}
...
I believe what drives her engagement with drawing is a combination of two things: first, a temperamental orientation toward visual observation — she notices the way light falls on surfaces and how things look from different angles in a way that most adults do not consciously register; and second, the particular satisfaction that comes from the measurable improvement that sustained drawing practice produces — she can see herself getting better, in a concrete and visible way, which is a form of feedback that other childhood activities rarely offer as clearly.
\end{ieltsanswer}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{cross-section} & n & /ˈkrɒs.sek.ʃən/ & a view of an object cut open to show its interior & mặt cắt ngang \\ \hline
\textbf{absorption} & n & /əbˈzɔːp.ʃən/ & deep focus and engagement in an activity & sự chìm đắm, tập trung sâu \\ \hline
\textbf{spontaneously} & adv & /spɒnˈteɪ.ni.əs.li/ & without being planned; naturally & một cách tự nhiên, không có kế hoạch \\ \hline
\textbf{critical intent} & & n phr & & the purpose of evaluating and improving something | ý định đánh giá, phê bình \\ \hline
\textbf{temperamental} & adj & /ˌtem.pər.əˈmen.təl/ & relating to a person's natural character or disposition & thuộc về tính cách bẩm sinh \\ \hline
\textbf{visual observation} & n phr & /ˈvɪʒ.u.əl ˌɒb.zəˈveɪ.ʃən/ & the careful noticing of what can be seen & quan sát thị giác \\ \hline
\textbf{fluently} & adv & /ˈfluː.ənt.li/ & smoothly and naturally, with ease & một cách trôi chảy, thuần thục \\ \hline
\textbf{sketchbook} & n & /ˈsketʃ.bʊk/ & a book of blank paper used for drawing & sổ phác thảo \\ \hline
\textbf{sustained} & adj & /səˈsteɪnd/ & maintained over a long period & được duy trì liên tục \\ \hline
\textbf{revise} & v & /rɪˈvaɪz/ & to look at and improve something again & xem xét lại và cải thiện \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{realism crisis} & & n phr & & the developmental stage when children recognise a gap between their art and reality | khủng hoảng hiện thực trong nghệ thuật trẻ em \\ \hline
\textbf{phenomenology} & n & /fɪˌnɒm.ɪˈnɒl.ə.dʒi/ & the study of conscious experience and perception & hiện tượng học \\ \hline
\textbf{cultural democratisation} & n phr & /ˌkʌl.tʃər.əl dɪˌmɒk.rə.taɪˈzeɪ.ʃən/ & making cultural access available to all social groups & dân chủ hóa văn hóa \\ \hline
\textbf{cross-subsidy} & n phr & /ˌkrɒs ˈsʌb.sɪ.di/ & using income from one source to fund access for another group & trợ cấp chéo \\ \hline
\textbf{contemplative attention} & n phr & /kənˈtem.plə.tɪv əˈten.ʃən/ & slow, deep focus given to experiencing something & chú ý chiêm nghiệm \\ \hline
\textbf{spatial reasoning} & n phr & /ˈspeɪ.ʃəl ˈriː.zən.ɪŋ/ & the ability to understand and think about shapes and space & lý luận không gian \\ \hline
\textbf{possibility-expansion} & & n phr & & the shift in beliefs about what is achievable, triggered by encountering great work | mở rộng nhận thức về khả năng \\ \hline
\textbf{fine motor control} & n phr & /faɪn ˈməʊ.tər kənˈtrəʊl/ & precise movement of small muscles, especially in the hands & kiểm soát vận động tinh \\ \hline
\textbf{inhibition} & n & /ˌɪn.hɪˈbɪʃ.ən/ & the restraining of an impulse or behaviour & sự ức chế, kìm hãm \\ \hline
\textbf{representational} & adj & /ˌrep.rɪ.zenˈteɪ.ʃən.əl/ & depicting objects as they appear in reality & mang tính tái hiện, biểu đạt thực tế \\ \hline
\end{tabularx}
\end{center}
...
The feature I find most valuable is the database functionality, which allows me to filter and view the same underlying information in multiple different formats depending on what I need at any given moment — a task list, a calendar, a table of prioritised decisions. It is not a perfect tool — it is slow, occasionally unreliable, and the learning curve for non-obvious features is steeper than it should be — but the underlying concept of a unified, customisable workspace has been genuinely transformative for how I manage complex information across multiple ongoing projects.
\end{ieltsanswer}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{knowledge management} & n phr & /ˈnɒl.ɪdʒ ˈmæn.ɪdʒ.mənt/ & the process of organising and using information effectively & quản lý tri thức \\ \hline
\textbf{scaffolding} & n & /ˈskæf.əl.dɪŋ/ & a temporary support structure; in learning, it means structured support for thinking & giàn giáo; hỗ trợ cấu trúc tư duy \\ \hline
\textbf{ephemeral} & adj & /ɪˈfem.ər.əl/ & lasting for only a short time & thoáng qua, ngắn ngủi \\ \hline
\textbf{decision journal} & n phr & /dɪˈsɪʒ.ən ˈdʒɜː.nəl/ & a record of decisions and the reasoning behind them & nhật ký quyết định \\ \hline
\textbf{database} & n & /ˈdeɪ.tə.beɪs/ & an organised collection of structured information & cơ sở dữ liệu \\ \hline
\textbf{learning curve} & n phr & /ˈlɜː.nɪŋ kɜːv/ & the rate at which a skill becomes easier with practice & đường cong học tập, độ khó ban đầu \\ \hline
\textbf{personal knowledge management} & & n phr & & a system for organising one's own notes and information | quản lý tri thức cá nhân \\ \hline
\textbf{interface} & n & /ˈɪn.tə.feɪs/ & the visual layout through which a user interacts with a program & giao diện \\ \hline
\textbf{integrate} & v & /ˈɪn.tɪ.ɡreɪt/ & to combine parts into a working whole & tích hợp \\ \hline
\textbf{dashboard} & n & /ˈdæʃ.bɔːd/ & a display that shows key information at a glance & bảng điều khiển, màn hình tổng quan \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{cognitive offloading} & n phr & /ˈkɒɡ.nɪ.tɪv ˈɒf.ləʊ.dɪŋ/ & using external tools to perform mental tasks & giảm tải nhận thức bằng công cụ bên ngoài \\ \hline
\textbf{deskilling} & n & /diːˈskɪl.ɪŋ/ & the gradual loss of skills due to over-reliance on automation & mất kỹ năng do phụ thuộc vào công nghệ \\ \hline
\textbf{age verification} & n phr & /eɪdʒ ˌver.ɪ.fɪˈkeɪ.ʃən/ & confirming a user's age before granting access & xác minh độ tuổi \\ \hline
\textbf{variable reward schedule} & & n phr & & a pattern of unpredictable rewards that drives compulsive behaviour | lịch trình thưởng ngẫu nhiên (gây nghiện) \\ \hline
\textbf{prefrontal regulation} & n phr & /ˌpriː.frʌn.təl ˌreɡ.jʊˈleɪ.ʃən/ & the brain's ability to control impulses and emotions & điều tiết vùng tiền trán \\ \hline
\textbf{onboarding} & n & /ˈɒn.bɔː.dɪŋ/ & the process of introducing a new user to a product & quá trình làm quen với phần mềm \\ \hline
\textbf{monetise} & v & /ˈmɒn.ɪ.taɪz/ & to convert something into a source of income & kiếm tiền từ, thương mại hóa \\ \hline
\textbf{digital literacy} & n phr & /ˈdɪdʒ.ɪ.təl ˈlɪt.ər.ə.si/ & the ability to use and critically evaluate digital tools & hiểu biết kỹ thuật số \\ \hline
\textbf{infinite scroll} & n phr & /ˈɪn.fɪ.nɪt skrəʊl/ & a design feature that continuously loads content to keep users engaged & cuộn vô hạn (thiết kế giữ người dùng) \\ \hline
\textbf{paternalism} & n & /pəˈtɜː.nə.lɪ.z(ə)m/ & restricting freedom for someone's own good & chủ nghĩa bảo hộ, can thiệp vì lợi ích của người khác \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{project brief} & n phr & /ˈprɒdʒ.ekt briːf/ & a short document outlining the goals and structure of a project & tóm tắt dự án \\ \hline
\textbf{risk register} & n phr & /rɪsk ˈredʒ.ɪ.stər/ & a document identifying potential project risks and responses & sổ đăng ký rủi ro \\ \hline
\textbf{buffer} & n & /ˈbʌf.ər/ & time or resource kept in reserve to absorb unexpected changes & vùng đệm, dự phòng \\ \hline
\textbf{psychological contract} & n phr & /ˌsaɪ.kəˈlɒdʒ.ɪ.kəl ˈkɒn.trækt/ & unwritten expectations between a team and its commitments & hợp đồng tâm lý \\ \hline
\textbf{sequencing} & n & /ˈsiː.kwəns.ɪŋ/ & the ordering of tasks in a logical or efficient series & sắp xếp thứ tự \\ \hline
\textbf{constraint} & n & /kənˈstreɪnt/ & a limitation that a plan must work within & ràng buộc, hạn chế \\ \hline
\textbf{contingency} & n & /kənˈtɪn.dʒən.si/ & a plan for what to do if something goes wrong & kế hoạch dự phòng \\ \hline
\textbf{pivot} & v & /ˈpɪv.ət/ & to change direction or approach in response to new information & xoay trục, thay đổi hướng \\ \hline
\textbf{perfunctory} & adj & /pəˈfʌŋk.tər.i/ & done routinely without real effort or care & qua quýt, làm lấy lệ \\ \hline
\textbf{resilient} & adj & /rɪˈzɪl.i.ənt/ & able to recover quickly from setbacks & kiên cường, có khả năng phục hồi \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{planning fallacy} & n phr & /ˈplæn.ɪŋ ˈfæl.ə.si/ & the tendency to underestimate the time and effort a task requires & sự sai lầm trong lập kế hoạch \\ \hline
\textbf{metacognitive} & adj & /ˌmet.ə.ˈkɒɡ.nɪ.tɪv/ & relating to awareness and understanding of one's own thought processes & thuộc tư duy siêu nhận thức \\ \hline
\textbf{interdependence} & n & /ˌɪn.tə.dɪˈpen.dəns/ & the state of being mutually reliant on each other & sự phụ thuộc lẫn nhau \\ \hline
\textbf{irreversibility} & n & /ɪˌrev.ə.sɪˈbɪl.ɪ.ti/ & the quality of not being able to be undone & tính không thể hoàn tác \\ \hline
\textbf{scenario analysis} & n phr & /sɪˈnɑː.ri.əʊ əˈnæl.ɪ.sɪs/ & examining possible future situations to plan responses & phân tích kịch bản \\ \hline
\textbf{credentialing} & n & /krɪˈden.ʃəl.ɪŋ/ & the formal process of certifying someone's qualifications & cấp chứng chỉ, xác nhận năng lực \\ \hline
\textbf{lead time} & n phr & /liːd taɪm/ & the time required between starting and completing a process & thời gian chuẩn bị trước \\ \hline
\textbf{non-linear} & adj & /ˌnɒn ˈlɪn.i.ər/ & not following a straight or predictable path & phi tuyến tính \\ \hline
\textbf{resource utilisation} & n phr & /rɪˈzɔːs ˌjuː.tɪ.laɪˈzeɪ.ʃən/ & making effective use of available resources & tận dụng nguồn lực \\ \hline
\textbf{premeditation} & n & /ˌpriː.med.ɪˈteɪ.ʃən/ & thinking or planning something out in advance & sự suy tính trước \\ \hline
\end{tabularx}
\end{center}
...
What I would want to discuss with him is not historical material from published texts but his current thinking on a specific problem: the tension between the universalist aspirations of capabilities theory and the political realities of implementation in societies with deep institutional fragility. That tension appears in his work but is not, I think, fully resolved — and I am curious whether he considers it a genuine unresolved problem or a manageable practical compromise. That kind of conversation — honest intellectual engagement at the frontier of someone's actual thinking — is what makes the prospect of meeting someone whose work you know deeply so different from simply attending a public lecture.
\end{ieltsanswer}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{essayist} & n & /ˈes.eɪ.ɪst/ & a writer who specialises in essays & nhà văn chuyên viết tản văn \\ \hline
\textbf{framing} & n & /ˈfreɪ.mɪŋ/ & the way something is presented or described & cách đặt vấn đề, cách tiếp cận \\ \hline
\textbf{public intellectual} & & n phr & & a thinker who engages with public issues through writing and media | trí thức công cộng \\ \hline
\textbf{capability} & n & /ˌkeɪ.pəˈbɪl.ɪ.ti/ & the real freedom of a person to achieve what they value & năng lực/ khả năng thực tế để sống tốt \\ \hline
\textbf{wellbeing} & n & /ˌwel.ˈbiː.ɪŋ/ & the state of being comfortable, healthy, and content & phúc lợi, sự thịnh vượng \\ \hline
\textbf{universalist} & adj & /ˌjuː.nɪˈvɜː.sə.lɪst/ & applying to or affecting all people everywhere & mang tính phổ quát \\ \hline
\textbf{institutional fragility} & & n phr & & weakness in the structures that uphold social order and governance | sự yếu kém về thể chế \\ \hline
\textbf{intellectual rigour} & n phr & /ˌɪn.tɪˈlek.tʃu.əl ˈrɪɡ.ər/ & precise, careful, and well-reasoned thinking & sự nghiêm ngặt trí tuệ \\ \hline
\textbf{narrative} & n & /ˈnær.ə.tɪv/ & a story or account; also the broader way a topic is framed & câu chuyện; cách kể chuyện \\ \hline
\textbf{frontier} & n & /ˈfrʌn.tɪər/ & the edge or most advanced point of knowledge or activity & biên giới, ranh giới (của tri thức) \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{prodigy} & n & /ˈprɒd.ɪ.dʒi/ & a person with exceptional talent at a young age & thần đồng \\ \hline
\textbf{gatekeeping} & n & /ˈɡeɪt.kiː.pɪŋ/ & controlling who is allowed access to a domain or opportunity & kiểm soát ngưỡng vào (quyền truy cập) \\ \hline
\textbf{commodification} & n & /kəˌmɒd.ɪ.fɪˈkeɪ.ʃən/ & treating something as a commercial product & sự thương phẩm hóa \\ \hline
\textbf{meritocratic} & adj & /ˌmer.ɪ.tɒˈkræt.ɪk/ & based on achievement and ability rather than privilege & dựa trên năng lực thực sự \\ \hline
\textbf{aspiration modelling} & & n phr & & providing a visible example that expands others' sense of the possible | mô hình hóa khát vọng \\ \hline
\textbf{algorithmic literacy} & & n phr & & understanding how to work effectively within platform algorithms | hiểu biết về thuật toán \\ \hline
\textbf{platform conversion} & & n phr & & using fame in one area to build resources for another | chuyển đổi nền tảng nổi tiếng \\ \hline
\textbf{social capital} & n phr & /ˈsəʊ.ʃəl ˈkæp.ɪ.təl/ & the networks and relationships that provide advantage & vốn xã hội \\ \hline
\textbf{community of practice} & & n phr & & a group of people who share expertise and learn together | cộng đồng thực hành \\ \hline
\textbf{identity crystallisation} & & n phr & & the premature fixing of one's sense of self before full development | kết tinh bản sắc sớm \\ \hline
\end{tabularx}
\end{center}
...
The building is a two-storey villa with characteristic louvred shutters, high ceilings, and a shaded verandah. The interior has been adapted for exhibition use without being aggressively modernised — original floor tiles and ceiling mouldings remain, creating a contextual conversation between the spaces and what they currently contain.

What makes it interesting to me is that it makes visible a historical problem — the relationship between colonial architectural legacy and contemporary Vietnamese professional and cultural identity — without pretending to have resolved it. The building is a site of productive tension, which is the kind of complexity that good architecture tends neither to smooth over nor to dramatise unnecessarily.
\end{ieltsanswer}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{façade} & n & /fəˈsɑːd/ & the front face of a building & mặt tiền tòa nhà \\ \hline
\textbf{louvred shutters} & n phr & /ˈluː.vəd ˈʃʌt.əz/ & window coverings with angled slats for airflow & cửa chớp có nan nghiêng \\ \hline
\textbf{colonial} & adj & /kəˈləʊ.ni.əl/ & relating to the period and style of colonial rule & thuộc địa \\ \hline
\textbf{ancestral hall} & n phr & /ænˈses.trəl hɔːl/ & a room in a traditional home dedicated to honouring ancestors & nhà thờ tổ tiên \\ \hline
\textbf{mother-of-pearl} & n phr & /ˌmʌð.ər.əv.ˈpɜːl/ & iridescent material from the inside of shells, used in decoration & xà cừ \\ \hline
\textbf{threshold} & n & /ˈθreʃ.həʊld/ & the strip of material at the bottom of a doorway & ngưỡng cửa \\ \hline
\textbf{verandah} & n & /vəˈræn.də/ & a roofed platform along the outside of a building & hành lang ngoài có mái \\ \hline
\textbf{moulding} & n & /ˈməʊl.dɪŋ/ & decorative strips of shaped material used as architectural ornament & đường gờ trang trí kiến trúc \\ \hline
\textbf{repurpose} & v & /ˌriːˈpɜː.pəs/ & to adapt something for a new use & tái sử dụng cho mục đích mới \\ \hline
\textbf{pre-industrial} & adj & /ˌpriːɪnˈdʌs.tri.əl/ & relating to the period before modern industry & tiền công nghiệp \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{tube house} & & n phr & & a characteristically narrow, deep Vietnamese urban dwelling | nhà ống \\ \hline
\textbf{vernacular} & adj & /vəˈnæk.jʊ.lər/ & relating to the local and traditional building style of a region & mang tính bản địa, phong trào kiến trúc dân gian \\ \hline
\textbf{daylighting} & n & /ˈdeɪ.laɪ.tɪŋ/ & the controlled admittance of natural light into a building & chiếu sáng tự nhiên \\ \hline
\textbf{footfall} & n & /ˈfʊt.fɔːl/ & the number of people entering a building or area & lượng khách đến \\ \hline
\textbf{acoustic separation} & & n phr & & the degree to which sound is prevented from passing between spaces | cách âm giữa các không gian \\ \hline
\textbf{built environment} & n phr & /bɪlt ɪnˈvaɪ.rən.mənt/ & the man-made surroundings in which people live and work & môi trường xây dựng \\ \hline
\textbf{temporal anchoring} & & n phr & & the experience of feeling connected to a specific moment in time | neo thời gian, cảm giác kết nối với lịch sử \\ \hline
\textbf{heritage} & n & /ˈher.ɪ.tɪdʒ/ & valued traditions and features passed down from earlier generations & di sản \\ \hline
\textbf{tiered pricing} & & n phr & & a pricing structure with different rates for different groups | giá theo bậc \\ \hline
\textbf{lifecycle} & n & /ˈlaɪf.saɪ.kəl/ & the total useful life of a product or building & vòng đời (của công trình) \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{restraint} & n & /rɪˈstreɪnt/ & the quality of being measured and controlled rather than excessive & sự tiết chế, kìm chế \\ \hline
\textbf{non-linear structure} & & n phr & & a narrative that does not follow chronological order | cấu trúc phi tuyến tính \\ \hline
\textbf{biographical drama} & & n phr & & a film based on the real life of a historical person | phim tiểu sử điện ảnh \\ \hline
\textbf{moral predicament} & n phr & /ˈmɒr.əl prɪˈdɪk.ə.mənt/ & a situation requiring a deeply difficult ethical decision & tình huống đạo đức tiến thoái lưỡng nan \\ \hline
\textbf{ambiguity} & n & /ˌæm.bɪˈɡjuː.ɪ.ti/ & the quality of being open to more than one interpretation & sự mơ hồ, đa nghĩa \\ \hline
\textbf{cinematographer} & n & /ˌsɪn.ə.məˈtɒɡ.rə.fər/ & the person responsible for a film's visual composition and lighting & nhà quay phim \\ \hline
\textbf{narrative arc} & & n phr & & the overall trajectory or shape of a story | cung truyện \\ \hline
\textbf{climax} & n & /ˈklaɪ.mæks/ & the most intense or important point of a story & cao trào \\ \hline
\textbf{character development} & & n phr & & the way a character changes and grows throughout a story | sự phát triển nhân vật \\ \hline
\textbf{thematic depth} & & n phr & & the degree to which a film or text engages with meaningful ideas | chiều sâu chủ đề \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{IP recognition} & & n phr & & audience familiarity with a brand, character, or franchise | nhận diện thương hiệu/nhân vật \\ \hline
\textbf{word-of-mouth} & n phr & /ˌwɜːd.əvˈmaʊθ/ & informal recommendation between people & truyền miệng \\ \hline
\textbf{box office} & n phr & /ˈbɒks ˌɒf.ɪs/ & the commercial performance of a film measured by ticket sales & doanh thu phòng vé \\ \hline
\textbf{auteur} & n & /əʊˈtɜː/ & a filmmaker whose personal vision dominates their work & đạo diễn phong cách cá nhân \\ \hline
\textbf{genre} & n & /ˈʒɒn.rə/ & a category of artistic work defined by shared conventions & thể loại \\ \hline
\textbf{immersive} & adj & /ɪˈmɜː.sɪv/ & creating a deeply involving experience & gây đắm chìm, tạo trải nghiệm nhập vai \\ \hline
\textbf{heuristic} & n & /hjʊˈrɪs.tɪk/ & a practical rule of thumb used to make quick decisions & phương pháp phán đoán nhanh \\ \hline
\textbf{surround sound} & n phr & /səˈraʊnd saʊnd/ & audio technology producing sound from multiple directions & âm thanh vòm \\ \hline
\textbf{distribution} & n & /ˌdɪs.trɪˈbjuː.ʃən/ & the process of making a film available to audiences & phân phối phim \\ \hline
\textbf{streaming} & n & /ˈstriː.mɪŋ/ & watching digital content delivered over the internet in real time & xem trực tuyến \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{encoding} & n & /ɪnˈkəʊ.dɪŋ/ & the process by which information is stored in memory & mã hóa thông tin vào bộ nhớ \\ \hline
\textbf{marginalia} & n & /ˌmɑː.dʒɪˈneɪ.li.ə/ & notes written in the margins of a text & ghi chú bên lề \\ \hline
\textbf{deliberate} & adj & /dɪˈlɪb.ər.ət/ & done consciously and intentionally & có chủ đích, thận trọng \\ \hline
\textbf{selectivity} & n & /sɪˌlek.ˈtɪv.ɪ.ti/ & the quality of choosing carefully among options & tính chọn lọc \\ \hline
\textbf{cognitive load} & & n phr & & the total amount of mental effort being used | tải nhận thức \\ \hline
\textbf{tactile} & adj & /ˈtæk.taɪl/ & relating to the sense of touch & thuộc về xúc giác \\ \hline
\textbf{dissipate} & v & /ˈdɪs.ɪ.peɪt/ & to gradually disappear or scatter & tan biến, phân tán \\ \hline
\textbf{retention} & n & /rɪˈten.ʃən/ & the ability to keep information in memory & khả năng ghi nhớ \\ \hline
\textbf{correspondence} & n & /ˌkɒr.ɪˈspɒn.dəns/ & formal written communication & thư từ, giao tiếp văn bản \\ \hline
\textbf{friction} & n & /ˈfrɪk.ʃən/ & in this context: productive resistance or slowness that improves quality & sự cản trở có lợi (trong tư duy/viết) \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{transitional object} & & n phr & & a comfort item (like a toy) that helps a child manage separation from caregivers | đối tượng chuyển tiếp (đồ vật mang lại cảm giác an toàn) \\ \hline
\textbf{loss aversion} & n phr & /lɒs əˈvɜː.ʒən/ & the tendency to feel losses more strongly than equivalent gains & sự ác cảm với mất mát \\ \hline
\textbf{endowment effect} & & n phr & & the tendency to value things more because you own them | hiệu ứng quyền sở hữu \\ \hline
\textbf{social proof} & & n phr & & using others' behaviour as a guide to form one's own | bằng chứng xã hội \\ \hline
\textbf{choice architecture} & & n phr & & the design of environments in which people make decisions | kiến trúc lựa chọn \\ \hline
\textbf{impulse purchasing} & & n phr & & buying something without planning or deliberation | mua sắm bốc đồng \\ \hline
\textbf{theory of mind} & & n phr & & the ability to understand that others have thoughts and feelings different from one's own | lý thuyết tâm trí \\ \hline
\textbf{anchoring} & n & /ˈæŋ.kər.ɪŋ/ & the cognitive bias of relying too heavily on the first piece of information encountered & neo nhận thức \\ \hline
\textbf{social commerce} & & n phr & & commercial transactions integrated into social media platforms | thương mại xã hội \\ \hline
\textbf{developmental window} & & n phr & & a critical period during which a skill is most easily acquired | cửa sổ phát triển (giai đoạn nhạy cảm) \\ \hline
\end{tabularx}
\end{center}
...
The lecture itself was technically precise, well-structured, and delivered with a composure that surprised everyone who knew how uncomfortable he had been with the invitation. What made me proud was not the performance — it was the willingness, at sixty-three, to learn a completely new form of communication and to take seriously the discomfort that learning required. That kind of intellectual courage, exercised quietly and without anyone requiring it of him, seems to me far more admirable than the professional achievements that the audience was there to hear about.
\end{ieltsanswer}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{self-sufficiency} & n & /ˌself.səˈfɪʃ.ən.si/ & the ability to manage independently without external support & sự tự lực \\ \hline
\textbf{preamble} & n & /ˈpriː.æm.bəl/ & an introductory statement before the main point & lời mở đầu, lời dẫn \\ \hline
\textbf{composure} & n & /kəmˈpəʊ.ʒər/ & calmness under pressure & sự điềm tĩnh \\ \hline
\textbf{portfolio} & n & /pɔːtˈfəʊ.li.əʊ/ & a collection of documents showcasing achievements & hồ sơ thành tích \\ \hline
\textbf{validation} & n & /ˌvæl.ɪˈdeɪ.ʃən/ & the recognition or confirmation of one's worth & sự công nhận, thừa nhận \\ \hline
\textbf{practitioner} & n & /prækˈtɪʃ.ən.ər/ & a person actively working in a professional field & người hành nghề \\ \hline
\textbf{intellectual courage} & & n phr & & willingness to engage with difficult or uncomfortable ideas | dũng khí trí tuệ \\ \hline
\textbf{sustained effort} & & n phr & & continuous, consistent work toward a goal | nỗ lực bền vững \\ \hline
\textbf{rehearse} & v & /rɪˈhɜːs/ & to practise before a performance or presentation & tập dượt, luyện tập \\ \hline
\textbf{precision} & n & /prɪˈsɪʒ.ən/ & the quality of being exact and accurate & sự chính xác \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{overjustification effect} & & n phr & & the reduction of intrinsic motivation caused by adding external rewards | hiệu ứng biện hộ quá mức \\ \hline
\textbf{intrinsic motivation} & n phr & /ɪnˈtrɪn.zɪk ˌməʊ.tɪˈveɪ.ʃən/ & motivation driven from within, not from external rewards & động lực nội tại \\ \hline
\textbf{extrinsic reward} & n phr & /ekˈstrɪn.zɪk/ & a reward given from an external source (e.g. money, grades) & phần thưởng bên ngoài \\ \hline
\textbf{prosocial} & adj & /ˌprəʊˈsəʊ.ʃəl/ & relating to behaviour intended to benefit others & mang tính vì người khác, xã hội tích cực \\ \hline
\textbf{burnout} & n & /ˈbɜːn.aʊt/ & exhaustion caused by prolonged stress or overwork & kiệt sức, cháy hết \\ \hline
\textbf{incentive system} & & n phr & & the structure of rewards and penalties that shapes behaviour | hệ thống khuyến khích \\ \hline
\textbf{resilience} & n & /rɪˈzɪl.i.əns/ & the ability to recover from setbacks & sức bật, khả năng phục hồi \\ \hline
\textbf{internalise} & v & /ɪnˈtɜː.nəl.aɪz/ & to absorb and adopt a value as part of one's own beliefs & nội tâm hóa, tiếp thu thành giá trị bản thân \\ \hline
\textbf{self-concept} & n & /ˈself.kɒn.sept/ & a person's understanding and image of themselves & tự nhận thức \\ \hline
\textbf{compliance} & n & /kəmˈplaɪ.əns/ & obedience to rules or authority & sự tuân thủ \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{itinerary} & n & /aɪˈtɪn.ər.ər.i/ & a planned route or schedule for a journey & lịch trình, kế hoạch hành trình \\ \hline
\textbf{restorative} & adj & /rɪˈstɔː.rə.tɪv/ & having the quality of refreshing or renewing energy & phục hồi, tái tạo năng lượng \\ \hline
\textbf{spatial} & adj & /ˈspeɪ.ʃəl/ & relating to space and the physical environment & thuộc không gian \\ \hline
\textbf{configuration} & n & /kənˌfɪɡ.jʊˈreɪ.ʃən/ & the way parts are arranged or set up & cấu hình, cách sắp xếp \\ \hline
\textbf{grade} & n & /ɡreɪd/ & the degree of inclination in a road or path & độ dốc \\ \hline
\textbf{insulate} & v & /ˈɪn.sjʊ.leɪt/ & to protect from external conditions & cách ly, bảo vệ khỏi môi trường bên ngoài \\ \hline
\textbf{province} & n & /ˈprɒv.ɪns/ & an administrative region of a country & tỉnh \\ \hline
\textbf{replicates} & v & /ˈrep.lɪ.keɪt/ & to reproduce or duplicate an effect & tái tạo, sao chép \\ \hline
\textbf{coastal} & adj & /ˈkəʊ.stəl/ & relating to or near a coast & ven biển \\ \hline
\textbf{infrastructure} & n & /ˈɪn.frə.strʌk.tʃər/ & the physical systems (roads, power, etc.) supporting a society & cơ sở hạ tầng \\ \hline
\end{tabularx}
\end{center}
...
The motorcycle is unquestionably the dominant personal transport vehicle in Vietnam, for reasons rooted in both historical economics and urban spatial constraints. During the decades when incomes were too low to support car ownership at scale, the motorcycle was the maximum accessible form of independent mobility, and a transport culture — its infrastructure, its commercial ecosystem, its social norms — developed around it that persists even as incomes have risen significantly. Urban road networks built during this period were also designed around motorcycle proportions rather than car proportions, which means that the city-level infrastructure still favours motorcycles over cars in many practical respects. The rising rate of car ownership among middle-income Vietnamese households reflects growing affluence rather than any change in the underlying logic, and the result — more cars on roads designed for motorcycles — is most visible in the traffic conditions of Hanoi and Ho Chi Minh City.
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{modal shift} & & n phr & & a change in the predominant form of transport used by people | chuyển đổi phương thức vận tải \\ \hline
\textbf{fleet} & n & /fliːt/ & the total number of vehicles in operation & đội phương tiện \\ \hline
\textbf{electrification} & n & /ɪˌlek.trɪ.fɪˈkeɪ.ʃən/ & the transition to electric power & điện khí hóa \\ \hline
\textbf{PM2.5} & & n phr & & fine particulate matter in the air that poses health risks | bụi mịn PM2.5 \\ \hline
\textbf{decarbonise} & v & /diːˈkɑː.bə.naɪz/ & to reduce or eliminate carbon emissions & khử carbon, giảm phát thải carbon \\ \hline
\textbf{lifecycle emissions} & & n phr & & total emissions produced over the entire lifespan of a product | phát thải vòng đời \\ \hline
\textbf{sprawl} & n & /sprɔːl/ & unplanned, spread-out urban development & đô thị hóa tràn lan \\ \hline
\textbf{ride-hailing} & n & /ˈraɪd.heɪ.lɪŋ/ & a service (like Grab) for booking transport via a smartphone app & gọi xe công nghệ \\ \hline
\textbf{emission standard} & & n phr & & a regulation limiting the amount of pollutants vehicles may produce | tiêu chuẩn khí thải \\ \hline
\textbf{spatial inequality} & & n phr & & unequal access to services or opportunities based on location | bất bình đẳng không gian \\ \hline
\end{tabularx}
\end{center}
...
The template was adopted within a month and the delays resolved. What made it smart was the diagnostic precision: she understood that the stated conflict (documentation format) masked a real conflict (perceived disrespect between teams), and that solving the stated conflict in a way that acknowledged the real one was the only approach that would actually be implemented. That kind of social intelligence — reading what a problem is actually about beneath what it appears to be about — is the most practically valuable form of problem-solving in organisational contexts.
\end{ieltsanswer}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{reframe} & v & /ˌriːˈfreɪm/ & to present or think about a problem in a different way & tái định nghĩa vấn đề \\ \hline
\textbf{diagnostic} & adj & /ˌdaɪ.əɡˈnɒs.tɪk/ & relating to identifying the root cause of a problem & liên quan đến chẩn đoán, xác định nguyên nhân \\ \hline
\textbf{interdepartmental} & adj & /ˌɪn.tə.dɪˌpɑːt.ˈmen.tl/ & involving more than one department & liên bộ phận \\ \hline
\textbf{friction} & n & /ˈfrɪk.ʃən/ & conflict or difficulty between people or groups & ma sát, mâu thuẫn \\ \hline
\textbf{implicit} & adj & /ɪmˈplɪs.ɪt/ & suggested without being directly stated & ngầm hiểu, không nói ra \\ \hline
\textbf{coordination} & n & /kəʊˌɔː.dɪˈneɪ.ʃən/ & the organisation of people or things to work effectively together & sự phối hợp \\ \hline
\textbf{lateral thinking} & & n phr & & solving problems using indirect or creative approaches | tư duy sáng tạo theo chiều ngang \\ \hline
\textbf{concede} & v & /kənˈsiːd/ & to admit or yield a point in an argument & nhượng bộ, thừa nhận \\ \hline
\textbf{template} & n & /ˈtem.pleɪt/ & a standard format used as a model & mẫu, khuôn mẫu \\ \hline
\textbf{social intelligence} & & n phr & & the ability to understand and navigate social situations effectively | trí tuệ xã hội \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{heritable} & adj & /ˈher.ɪ.tə.bəl/ & capable of being passed from parent to child genetically & có thể di truyền \\ \hline
\textbf{pedagogy} & n & /ˈped.ə.ɡɒ.dʒi/ & the theory and practice of teaching & phương pháp giảng dạy, sư phạm học \\ \hline
\textbf{growth mindset} & & n phr & & the belief that abilities can be developed through dedication and effort | tư duy phát triển \\ \hline
\textbf{deliberate practice} & & n phr & & highly focused practice designed to improve specific skills | luyện tập có chủ đích \\ \hline
\textbf{cognitive diversity} & & n phr & & a range of different thinking styles and approaches within a group | đa dạng nhận thức \\ \hline
\textbf{cognitive profile} & & n phr & & the pattern of a person's different mental strengths and weaknesses | hồ sơ nhận thức \\ \hline
\textbf{predispose} & v & /ˌpriː.dɪˈspəʊz/ & to make someone likely to think or behave in a particular way & khiến có xu hướng \\ \hline
\textbf{self-fulfilling prophecy} & & n phr & & a belief that causes itself to become true through behaviour | lời tiên tri tự hiện thực hóa \\ \hline
\textbf{homogeneous} & adj & /ˌhɒm.əˈdʒiː.ni.əs/ & of the same type or nature; lacking diversity & đồng nhất \\ \hline
\textbf{undifferentiated} & adj & /ˌʌn.dɪˈfer.ən.ʃi.eɪ.tɪd/ & not adapted to individual differences & không phân hoá, không cá nhân hoá \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{composure} & n & /kəmˈpəʊ.ʒər/ & calmness and self-control, especially in difficult situations & sự bình thản, điềm tĩnh \\ \hline
\textbf{debrief} & n & /ˌdiːˈbriːf/ & a meeting to review and discuss what happened during a project or event & buổi tổng kết, báo cáo sau sự kiện \\ \hline
\textbf{attentive} & adj & /əˈten.tɪv/ & paying close and careful attention & chú tâm, cẩn thận \\ \hline
\textbf{gratitude} & n & /ˈɡræt.ɪ.tjuːd/ & the feeling of being thankful & lòng biết ơn \\ \hline
\textbf{interpersonal} & adj & /ˌɪn.tə.ˈpɜː.sən.əl/ & relating to relationships between people & giữa người với người \\ \hline
\textbf{scope} & n & /skəʊp/ & the range or extent of something & phạm vi \\ \hline
\textbf{concise} & adj & /kənˈsaɪs/ & expressed clearly and briefly & súc tích \\ \hline
\textbf{composure} & & n & & calmness under pressure | sự điềm tĩnh \\ \hline
\textbf{anticipate} & v & /ænˈtɪs.ɪ.peɪt/ & to expect or predict something in advance & dự đoán, đoán trước \\ \hline
\textbf{implicit} & adj & /ɪmˈplɪs.ɪt/ & suggested without being directly stated & ngầm hiểu \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{display rules} & & n phr & & cultural norms about which emotions are appropriate to express | quy tắc biểu đạt cảm xúc \\ \hline
\textbf{social artefact} & & n phr & & an object or behaviour that carries social meaning | hiện vật/biểu hiện mang ý nghĩa xã hội \\ \hline
\textbf{performative} & adj & /pəˈfɔː.mə.tɪv/ & done for social effect rather than genuine expression & mang tính trình diễn \\ \hline
\textbf{affiliative} & adj & /əˈfɪl.i.ə.tɪv/ & relating to a desire for social connection and belonging & liên kết, gắn kết xã hội \\ \hline
\textbf{socioemotional selectivity} & & n phr & & an age-related tendency to prioritise meaningful goals and relationships | tính chọn lọc cảm xúc xã hội \\ \hline
\textbf{emotional labour} & & n phr & & the effort of managing one's emotions as part of a job | lao động cảm xúc \\ \hline
\textbf{self-monitoring} & & n phr & & the ability to regulate one's own behaviour based on social cues | tự điều chỉnh hành vi \\ \hline
\textbf{positive affect} & & n phr & & the experience of positive emotional states | cảm xúc tích cực \\ \hline
\textbf{gender norms} & & n phr & & social expectations about how men and women should behave | chuẩn mực giới \\ \hline
\textbf{cross-cultural} & adj & /ˌkrɒs.ˈkʌl.tʃər.əl/ & involving or comparing different cultures & liên văn hóa \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{surrender} & v & /səˈren.dər/ & to hand something over, especially by requirement & nộp lại, giao nộp \\ \hline
\textbf{resentful} & adj & /rɪˈzent.fəl/ & feeling bitterness or indignation about something & bực bội, cảm thấy bực bội \\ \hline
\textbf{normalise} & v & /ˈnɔː.mə.laɪz/ & to become or make acceptable and ordinary & trở nên bình thường, quen dần \\ \hline
\textbf{dependency} & n & /dɪˈpen.dən.si/ & the state of relying too much on something & sự phụ thuộc \\ \hline
\textbf{rationale} & n & /ˌræʃ.əˈnɑːl/ & the underlying reasons for a decision & cơ sở lý luận, lý do \\ \hline
\textbf{retreat} & n & /rɪˈtriːt/ & a period spent away from normal work for reflection or training & kỳ rút lui/tĩnh tâm \\ \hline
\textbf{strategic} & adj & /strəˈtiː.dʒɪk/ & relating to careful planning for long-term goals & mang tính chiến lược \\ \hline
\textbf{uninterrupted} & adj & /ˌʌn.ɪn.təˈrʌp.tɪd/ & continuing without being stopped & không bị gián đoạn \\ \hline
\textbf{enforce} & v & /ɪnˈfɔːs/ & to make sure a rule is followed & thực thi (quy tắc) \\ \hline
\textbf{sustained attention} & & n phr & & the ability to maintain focus over a long period | sự chú ý bền vững \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{ambient} & adj & /ˈæm.bi.ənt/ & present and surrounding in an environment, often unnoticed & xung quanh, hiện diện khắp nơi \\ \hline
\textbf{paralinguistic} & adj & /ˌpær.ə.lɪŋˈɡwɪs.tɪk/ & relating to vocal and non-verbal cues that accompany speech & cận ngôn ngữ \\ \hline
\textbf{instrumentally} & adv & /ɪnˈstrʌ.men.tə.li/ & used as a means to an end & mang tính công cụ \\ \hline
\textbf{paternalism} & n & /pəˈtɜː.nə.lɪ.zəm/ & restricting someone's freedom for their own good & chủ nghĩa bảo hộ (can thiệp vì lợi ích người khác) \\ \hline
\textbf{externality} & n & /ˌek.stəˈnæl.ɪ.ti/ & a cost or benefit that affects a third party & ngoại ứng (tác động ngoài) \\ \hline
\textbf{gatekeeping} & n & /ˈɡeɪt.kiː.pɪŋ/ & controlling access to information or resources & kiểm soát quyền truy cập \\ \hline
\textbf{etiquette} & n & /ˈet.ɪ.kɪt/ & the customary code of polite behaviour & lễ nghi, phép lịch sự \\ \hline
\textbf{democratisation} & n & /dɪˌmɒk.rə.taɪˈzeɪ.ʃən/ & making something accessible to all & dân chủ hóa \\ \hline
\textbf{infrastructural} & adj & /ˌɪn.frə.ˈstrʌk.tʃər.əl/ & relating to the basic systems and services & thuộc cơ sở hạ tầng \\ \hline
\textbf{cognitive impairment} & & n phr & & a reduction in mental abilities such as attention or memory | suy giảm nhận thức \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{temperament} & n & /ˈtem.prə.mənt/ & a person's natural way of thinking, behaving, or reacting & tính khí, khí chất \\ \hline
\textbf{persistent} & adj & /pəˈsɪs.tənt/ & continuing firmly in a course of action despite difficulty & kiên trì \\ \hline
\textbf{understated} & adj & /ˌʌn.dəˈsteɪ.tɪd/ & expressed or described with less emphasis than expected & kiệm lời, không phô trương \\ \hline
\textbf{diagnostic honesty} & & n phr & & the act of clearly naming what the real problem is | sự thành thật mang tính chẩn đoán \\ \hline
\textbf{exposure} & n & /ɪkˈspəʊ.ʒər/ & the state of being publicly visible or evaluated & sự phơi bày, công khai \\ \hline
\textbf{threshold} & n & /ˈθreʃ.həʊld/ & the level at which something begins or is considered sufficient & ngưỡng \\ \hline
\textbf{overexposure} & n & /ˌəʊ.vər.ɪkˈspəʊ.ʒər/ & excessive familiarity with something causing reduced perspective & tiếp xúc quá mức \\ \hline
\textbf{methodologist} & n & /ˌmeθ.əˈdɒl.ə.dʒɪst/ & an expert in research methods & chuyên gia về phương pháp nghiên cứu \\ \hline
\textbf{reassurance} & n & /ˌriː.əˈʃʊər.əns/ & the act of removing doubts and fears & sự trấn an, củng cố niềm tin \\ \hline
\textbf{navigational care} & & n phr & & tactful management of a sensitive social situation | sự khéo léo trong giao tiếp \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{self-efficacy} & n & /ˌself.ˈef.ɪ.kə.si/ & a person's belief in their own ability to succeed & tự tin vào năng lực bản thân \\ \hline
\textbf{autonomy-supportive} & & adj phr & & an environment that nurtures independent decision-making | hỗ trợ tính tự chủ \\ \hline
\textbf{intrinsic motivation} & n phr & /ɪnˈtrɪn.zɪk/ & drive that comes from within rather than external rewards & động lực nội tại \\ \hline
\textbf{attrition} & n & /əˈtrɪʃ.ən/ & gradual reduction in staff through resignation, not dismissal & hao hụt nhân sự tự nhiên \\ \hline
\textbf{self-determination theory} & & n phr & & a psychological framework that explains motivation through autonomy, competence, and relatedness | lý thuyết tự quyết \\ \hline
\textbf{moral agency} & & n phr & & the capacity to make independent ethical decisions | năng lực hành đạo đức \\ \hline
\textbf{calibration} & n & /ˌkæl.ɪˈbreɪ.ʃən/ & the process of adjusting something to the right level & hiệu chuẩn, điều chỉnh đúng mức \\ \hline
\textbf{palliative} & adj & /ˈpæl.i.ə.tɪv/ & relieving symptoms without solving the root cause & xoa dịu tạm thời, không trị tận gốc \\ \hline
\textbf{relatedness} & n & /rɪˈleɪ.tɪd.nəs/ & the sense of meaningful connection to others & cảm giác được kết nối với người khác \\ \hline
\textbf{graduate} & v & /ˈɡrædʒ.u.eɪt/ & to move or progress through a staged process & tiến dần qua từng giai đoạn \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{celadon} & n & /ˈsel.ə.dɒn/ & a pale grey-green ceramic glaze originating in East Asia & men sứ xanh ngọc celadon \\ \hline
\textbf{crackle pattern} & & n phr & & a decorative texture of fine cracks in ceramic glaze | hoa văn nứt tế vi trên men gốm \\ \hline
\textbf{appraise} & v & /əˈpreɪz/ & to assess the monetary value of something & định giá, thẩm định \\ \hline
\textbf{testimony} & n & /ˈtes.tɪ.mə.ni/ & a firsthand account of events or experiences & chứng nhân, lời chứng \\ \hline
\textbf{associative weight} & & n phr & & the emotional significance an object gains through shared memory | trọng lượng liên tưởng \\ \hline
\textbf{consequential} & adj & /ˌkɒn.sɪˈkwen.ʃəl/ & having significant impact or importance & quan trọng, có hệ quả lớn \\ \hline
\textbf{transmitted} & adj & /trænsˈmɪ.tɪd/ & passed from one person or generation to another & được truyền lại \\ \hline
\textbf{heirloom} & n & /ˈeə.luːm/ & a valuable object passed down through generations & di vật gia truyền \\ \hline
\textbf{temporal} & adj & /ˈtem.pər.əl/ & relating to time & thuộc về thời gian \\ \hline
\textbf{detachment} & n & /dɪˈtætʃ.mənt/ & emotional distance when observing or describing events & sự khách quan, tách biệt cảm xúc \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{digitisation} & n & /ˌdɪdʒ.ɪ.taɪˈzeɪ.ʃən/ & the process of converting information into digital form & số hóa \\ \hline
\textbf{curatorial} & adj & /ˌkjʊər.əˈtɔː.ri.əl/ & relating to the work of organising a museum or exhibition & thuộc về curation (quản lý bộ sưu tập) \\ \hline
\textbf{artefact} & n & /ˈɑː.tɪ.fækt/ & an object made by humans, especially one of historical interest & hiện vật \\ \hline
\textbf{colonial extraction} & & n phr & & the removal of cultural objects from colonised lands | khai thác thuộc địa (văn hoá) \\ \hline
\textbf{planned obsolescence} & & n phr & & designing products with a limited useful life to encourage replacement | lỗi thời có kế hoạch \\ \hline
\textbf{stewardship} & n & /ˈstjuː.əd.ʃɪp/ & the responsible management of something entrusted to one's care & sự quản lý có trách nhiệm \\ \hline
\textbf{haptic} & adj & /ˈhæp.tɪk/ & relating to the sense of touch in technology interfaces & xúc giác (trong công nghệ) \\ \hline
\textbf{equity} & n & /ˈek.wɪ.ti/ & fairness and equal access to opportunities & công bằng, bình đẳng \\ \hline
\textbf{interpretive} & adj & /ɪnˈtɜː.prɪ.tɪv/ & relating to explaining or understanding the meaning of something & mang tính diễn giải \\ \hline
\textbf{primary source} & & n phr & & original documents or artefacts from the time period under study | tài liệu gốc, nguồn sơ cấp \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{scenario planning} & & n phr & & a strategic method using multiple imagined futures to prepare robust plans | lập kế hoạch dựa trên kịch bản \\ \hline
\textbf{extrapolation} & n & /ɪkˌstræp.əˈleɪ.ʃən/ & extending known data into unknown territory & ngoại suy \\ \hline
\textbf{ambient} & adj & /ˈæm.bi.ənt/ & relating to the surrounding environment or atmosphere & xung quanh, bầu không khí \\ \hline
\textbf{perceptual} & adj & /pəˈsep.tʃu.əl/ & relating to the ability to interpret sensory experience & thuộc tri giác \\ \hline
\textbf{divergent} & adj & /daɪˈvɜː.dʒənt/ & developing in different directions; not converging & phân kỳ, khác nhau \\ \hline
\textbf{robust} & adj & /rəʊˈbʌst/ & strong and effective across a range of conditions & bền vững, có khả năng chống chịu \\ \hline
\textbf{exploratory} & adj & /ɪkˈsplɒr.ə.tər.i/ & intended to investigate rather than to confirm & mang tính khám phá \\ \hline
\textbf{cognitive discomfort} & & n phr & & the mental unease produced by uncertainty or contradiction | sự khó chịu nhận thức \\ \hline
\textbf{compelling} & adj & /kəmˈpel.ɪŋ/ & convincing and powerfully persuasive & thuyết phục, hấp dẫn \\ \hline
\textbf{suspend} & v & /səˈspend/ & to temporarily set aside or delay & tạm gác lại \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{divergent thinking} & & n phr & & the process of generating many different ideas or solutions | tư duy phân kỳ \\ \hline
\textbf{theory of mind} & n phr & /ˈθɪər.i ɒv maɪnd/ & the ability to attribute mental states to others & lý thuyết tâm lý (hiểu người khác có suy nghĩ riêng) \\ \hline
\textbf{pretend play} & & n phr & & imaginative role-playing in young children | trò chơi giả vờ, đóng vai \\ \hline
\textbf{counterfactual} & adj & /ˌkaʊn.tə.ˈfæk.tʃu.əl/ & relating to alternative scenarios that did not occur & phản thực tế, giả định ngược \\ \hline
\textbf{spatial reasoning} & & n phr & & the ability to mentally visualise and manipulate objects in space | tư duy không gian \\ \hline
\textbf{paradigm} & n & /ˈpær.ə.daɪm/ & a typical example or framework of thinking in a field & mô hình tư duy, hệ hình \\ \hline
\textbf{free play} & & n phr & & unstructured, child-directed play without adult-imposed rules | chơi tự do \\ \hline
\textbf{narrative imagination} & & n phr & & the capacity to construct and inhabit stories or mental scenarios | trí tưởng tượng kể chuyện \\ \hline
\textbf{iterative} & adj & /ˈɪt.ər.ə.tɪv/ & involving repetition of a process to refine a result & lặp đi lặp lại để cải tiến \\ \hline
\textbf{hypothesis} & n & /haɪˈpɒθ.ɪ.sɪs/ & a testable proposition that explains observed phenomena & giả thuyết \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{heuristic} & n & /hjʊˈrɪs.tɪk/ & a mental shortcut used to make decisions quickly & phương pháp tư duy tắt, heuristic \\ \hline
\textbf{cognitive bias} & & n phr & & a systematic error in thinking that affects judgments | thiên kiến nhận thức \\ \hline
\textbf{anchoring effect} & & n phr & & the tendency to rely too heavily on the first piece of information encountered | hiệu ứng neo đậu \\ \hline
\textbf{loss aversion} & & n phr & & the tendency to prefer avoiding losses over acquiring gains | ác cảm thua lỗ \\ \hline
\textbf{throughput} & n & /ˈθruː.pʊt/ & the amount of work completed in a given period & năng suất xử lý, thông lượng \\ \hline
\textbf{queuing theory} & & n phr & & the mathematical study of waiting lines and their effects | lý thuyết hàng đợi \\ \hline
\textbf{counterintuitive} & adj & /ˌkaʊn.tər.ɪnˈtjuː.ɪ.tɪv/ & contrary to what one would expect & trái với trực giác \\ \hline
\textbf{variability} & n & /ˌveər.i.əˈbɪl.ɪ.ti/ & the tendency to change or vary & tính biến thiên \\ \hline
\textbf{availability bias} & & n phr & & the tendency to overweight easily recalled examples | thiên kiến sẵn có \\ \hline
\textbf{prescription} & n & /prɪˈskrɪp.ʃən/ & a recommended course of action & hướng dẫn, chỉ định hành động \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{serendipitous} & adj & /ˌser.ənˈdɪp.ɪ.təs/ & occurring by happy chance or pleasant accident & tình cờ may mắn \\ \hline
\textbf{discretionary time} & & n phr & & time free from obligatory duties | thời gian tự do, tuỳ ý sử dụng \\ \hline
\textbf{curate} & v & /kjʊˈreɪt/ & to carefully select and organise content for an audience & chọn lọc và tổ chức nội dung \\ \hline
\textbf{information literacy} & & n phr & & the ability to find, evaluate, and use information effectively | năng lực thông tin \\ \hline
\textbf{equity infrastructure} & & n phr & & systems designed to ensure fair access for all | cơ sở hạ tầng bình đẳng \\ \hline
\textbf{value proposition} & & n phr & & the reason why someone should choose a service or product | giá trị đề xuất, lý do chọn dùng \\ \hline
\textbf{algorithmic recommendation} & & n phr & & suggestions generated by automated systems based on user behaviour | đề xuất thuật toán \\ \hline
\textbf{marginal cost} & & n phr & & the cost of producing one additional unit | chi phí cận biên \\ \hline
\textbf{outcome measurement} & & n phr & & the process of tracking the results and impacts of a programme | đo lường kết quả \\ \hline
\textbf{heritage} & n & /ˈher.ɪ.tɪdʒ/ & the traditions, values, and objects passed down through history & di sản \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{typographically} & adv & /ˌtaɪ.pəˈɡræf.ɪ.kli/ & in a way relating to the style and arrangement of text & về mặt typography (nghệ thuật sắp chữ) \\ \hline
\textbf{calligraphic} & adj & /ˌkæl.ɪˈɡræf.ɪk/ & relating to the art of beautiful handwriting & thuộc thư pháp \\ \hline
\textbf{self-indulgent} & adj & /ˌself.ɪnˈdʌl.dʒənt/ & focused on personal gratification rather than purpose & tự chiều chuộng, không chú ý nhu cầu người khác \\ \hline
\textbf{typology} & n & /taɪˈpɒl.ə.dʒi/ & a system of classification based on shared types & loại học, phân loại theo kiểu \\ \hline
\textbf{granular} & adj & /ˈɡræn.jʊ.lər/ & detailed and specific rather than general & chi tiết, cụ thể \\ \hline
\textbf{spatial} & adj & /ˈspeɪ.ʃəl/ & relating to space and how things are arranged within it & thuộc về không gian \\ \hline
\textbf{accountability} & n & /əˌkaʊn.tə.ˈbɪl.ɪ.ti/ & responsibility or answerability for one's decisions & trách nhiệm giải trình \\ \hline
\textbf{observational research} & & n phr & & research based on systematic direct observation | nghiên cứu quan sát \\ \hline
\textbf{spectacle} & n & /ˈspek.tə.kəl/ & something visually striking but perhaps lacking substance & cảnh tượng hoành tráng, trình diễn \\ \hline
\textbf{conceptually} & adv & /kənˈsep.tʃu.ə.li/ & in terms of underlying ideas or principles & về mặt khái niệm \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{phonological processing} & & n phr & & the ability to hear and manipulate sound units in language | xử lý ngữ âm \\ \hline
\textbf{incubation} & n & /ˌɪŋ.kjʊˈbeɪ.ʃən/ & a period of unconscious problem-solving while mentally resting & ủ ý tưởng (giai đoạn tiềm thức) \\ \hline
\textbf{base rate} & & n phr & & the underlying frequency of an event in a population | tỷ lệ nền, tần suất cơ bản \\ \hline
\textbf{documentary evidence} & & n phr & & proof based on recorded records or images | bằng chứng tài liệu \\ \hline
\textbf{salience} & n & /ˈseɪ.li.əns/ & the quality of being particularly noticeable or important & sự nổi bật \\ \hline
\textbf{externalise} & v & /ɪkˈstɜː.nə.laɪz/ & to express or represent internal thoughts outwardly & biểu đạt ra bên ngoài \\ \hline
\textbf{iterative refinement} & & n phr & & improving something through repeated cycles of revision | tinh chỉnh lặp đi lặp lại \\ \hline
\textbf{wide sampling} & & n phr & & exposure to a broad range of ideas and stimuli to fuel creativity | lấy mẫu rộng (trong nghiên cứu sáng tạo) \\ \hline
\textbf{generative creativity} & & n phr & & the ability to produce entirely new ideas or solutions | sáng tạo sinh thành \\ \hline
\textbf{adaptive creativity} & & n phr & & creativity applied to solving problems in new contexts | sáng tạo thích ứng \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{overland} & adj/adv & /ˌəʊ.vəˈlænd/ & travelling by road or land rather than air or sea & theo đường bộ, băng qua đất liền \\ \hline
\textbf{latitude} & n & /ˈlæt.ɪ.tjuːd/ & distance north or south of the equator & vĩ độ \\ \hline
\textbf{topographic} & adj & /ˌtɒp.əˈɡræf.ɪk/ & relating to the physical features of an area of land & địa hình học \\ \hline
\textbf{continuity} & n & /ˌkɒn.tɪˈnjuː.ɪ.ti/ & the unbroken connection of successive parts & tính liên tục \\ \hline
\textbf{implementation} & n & /ˌɪm.plɪ.menˈteɪ.ʃən/ & the process of putting a plan into action & thực thi, thực hiện \\ \hline
\textbf{sequential} & adj & /sɪˈkwen.ʃəl/ & following a particular order; one after another & tuần tự, theo thứ tự \\ \hline
\textbf{infrastructure} & n & /ˈɪn.frə.strʌk.tʃər/ & the basic physical systems supporting a society & cơ sở hạ tầng \\ \hline
\textbf{itinerary} & n & /aɪˈtɪn.ər.ər.i/ & a planned route or journey schedule & hành trình, lịch trình \\ \hline
\textbf{temperate} & adj & /ˈtem.pər.ət/ & having mild weather, not extreme heat or cold & ôn đới \\ \hline
\textbf{discrete} & adj & /dɪˈskriːt/ & individually separate and distinct & riêng biệt, không liên kết \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{calculus} & n & /ˈkæl.kjʊ.ləs/ & a method of reasoning about trade-offs or complex decisions & phép tính cân nhắc lợi hại \\ \hline
\textbf{serendipitous} & adj & /ˌser.ənˈdɪp.ɪ.təs/ & occurring by chance in a beneficial way & tình cờ may mắn \\ \hline
\textbf{recalibrate} & v & /ˌriːˈkæl.ɪ.breɪt/ & to adjust one's thinking or approach based on new information & điều chỉnh lại framework nhận thức \\ \hline
\textbf{immersion} & n & /ɪˈmɜː.ʃən/ & complete involvement in a different environment or culture & sự đắm chìm (trong môi trường mới) \\ \hline
\textbf{contingency} & n & /kənˈtɪn.dʒən.si/ & the fact that something depends on uncertain conditions & tính ngẫu nhiên, phụ thuộc hoàn cảnh \\ \hline
\textbf{cognitive rigidity} & & n phr & & the tendency to think in fixed, inflexible mental patterns | cứng nhắc nhận thức \\ \hline
\textbf{habituate} & v & /həˈbɪtʃ.u.eɪt/ & to become so accustomed to something that it no longer draws attention & quen dần, mất cảm giác mới lạ \\ \hline
\textbf{field note} & & n phr & & written observations made by researchers during direct fieldwork | ghi chú thực địa \\ \hline
\textbf{door-to-door} & & adj phr & & accounting for the total time from origin to final destination | từ cửa đến cửa (tổng thời gian di chuyển) \\ \hline
\textbf{perspective-taking} & & n phr & & the cognitive act of understanding a situation from another's point of view | lấy góc nhìn người khác \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{confectionery} & n & /kənˈfek.ʃən.ər.i/ & sweets and other sugar-based food products & bánh kẹo, đồ ngọt \\ \hline
\textbf{shelf life} & & n phr & & the length of time a product remains usable or sellable | thời hạn sử dụng \\ \hline
\textbf{contractual} & adj & /kənˈtræk.tʃu.əl/ & relating to or based on a formal agreement & theo hợp đồng \\ \hline
\textbf{supplier relationship} & & n phr & & the ongoing connection between a business and those who provide goods | mối quan hệ với nhà cung cấp \\ \hline
\textbf{supply chain} & & n phr & & the entire system of production, processing, and distribution of goods | chuỗi cung ứng \\ \hline
\textbf{compound} & v & /ˈkɒm.paʊnd/ & to grow by accumulation over time & tích lũy, gia tăng theo thời gian \\ \hline
\textbf{institutional distance} & & n phr & & the separation between an employee and the real-world effects of their work | khoảng cách thể chế \\ \hline
\textbf{relational} & adj & /rɪˈleɪ.ʃən.əl/ & relating to or based on personal connections and trust & dựa trên mối quan hệ \\ \hline
\textbf{quality control} & & n phr & & the process of maintaining standards in production | kiểm soát chất lượng \\ \hline
\textbf{amplify} & v & /ˈæm.plɪ.faɪ/ & to increase the strength or effect of something & khuếch đại, tăng cường \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{principal-agent problem} & & n phr & & a conflict of interest between owners and hired managers | vấn đề ủy thác - đại lý \\ \hline
\textbf{succession planning} & & n phr & & preparing for the transition of leadership to the next generation | lập kế hoạch kế thừa \\ \hline
\textbf{meritocratic} & adj & /ˌmer.ɪ.təˈkræt.ɪk/ & based on ability and performance rather than privilege & dựa trên năng lực \\ \hline
\textbf{agency cost} & & n phr & & costs resulting from the conflict of interest between owners and managers | chi phí đại lý \\ \hline
\textbf{governance} & n & /ˈɡʌv.ər.nəns/ & the system by which an organisation is controlled and directed & quản trị (tổ chức) \\ \hline
\textbf{relational capital} & & n phr & & the value embedded in trusted relationships with stakeholders | vốn quan hệ \\ \hline
\textbf{patient capital} & & n phr & & long-term investment that does not demand quick returns | vốn kiên nhẫn, đầu tư dài hạn \\ \hline
\textbf{stakeholder} & n & /ˈsteɪk.həʊl.dər/ & anyone with an interest in or affected by an organisation & các bên liên quan \\ \hline
\textbf{embedded knowledge} & & n phr & & expertise deeply rooted in context and relationships | tri thức nhúng/tiềm ẩn \\ \hline
\textbf{undiversified} & adj & /ˌʌn.daɪˈvɜː.sɪ.faɪd/ & overly concentrated in one area without spreading risk & chưa đa dạng hoá \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{arboreal} & adj & /ɑːˈbɔː.ri.əl/ & living in or adapted to life in trees & sống trên cây \\ \hline
\textbf{morphological} & adj & /ˌmɔː.fəˈlɒdʒ.ɪ.kəl/ & relating to the form and structure of an organism & về hình thái học \\ \hline
\textbf{telemetry} & n & /tɪˈlem.ɪ.tri/ & the process of remotely tracking animals via electronic devices & đo lường từ xa (theo dõi động vật) \\ \hline
\textbf{felid} & n & /ˈfiː.lɪd/ & a member of the cat family (Felidae) & họ mèo \\ \hline
\textbf{camera trap} & & n phr & & a remotely triggered camera used to photograph wildlife | bẫy ảnh (thiết bị chụp ảnh động vật hoang dã) \\ \hline
\textbf{riverine} & adj & /ˈrɪv.ər.aɪn/ & relating to or situated on a river & thuộc môi trường sông \\ \hline
\textbf{endangered} & adj & /ɪnˈdeɪn.dʒəd/ & at serious risk of extinction & nguy cấp (về bảo tồn) \\ \hline
\textbf{fragmentation} & n & /ˌfræɡ.menˈteɪ.ʃən/ & the breaking up of a habitat into isolated patches & phân mảnh (sinh cảnh) \\ \hline
\textbf{nocturnal} & adj & /nɒkˈtɜː.nəl/ & active at night & hoạt động ban đêm \\ \hline
\textbf{cooperative} & adj & /kəʊˈɒp.ər.ə.tɪv/ & involving mutual effort between different parties & hợp tác, cùng làm \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{biodiversity} & n & /ˌbaɪ.əʊ.daɪˈvɜː.sɪ.ti/ & the variety of living species in a habitat or on Earth & đa dạng sinh học \\ \hline
\textbf{ecosystem services} & & n phr & & the benefits that ecosystems provide to humans | dịch vụ hệ sinh thái \\ \hline
\textbf{charismatic megafauna} & & n phr & & large, appealing animals that attract public conservation attention | động vật lớn hấp dẫn (thu hút sự ủng hộ bảo tồn) \\ \hline
\textbf{loss aversion} & & n phr & & the tendency to feel losses more strongly than equivalent gains | ác cảm mất mát \\ \hline
\textbf{translocation} & n & /ˌtræns.ləˈkeɪ.ʃən/ & the deliberate moving of species to new habitats for conservation & chuyển vị (di chuyển loài để bảo tồn) \\ \hline
\textbf{captive breeding} & & n phr & & the process of breeding wild animals in controlled environments | nhân giống trong điều kiện nuôi nhốt \\ \hline
\textbf{flagship species} & & n phr & & a high-profile species used to raise conservation awareness | loài biểu tượng bảo tồn \\ \hline
\textbf{pollinator} & n & /ˈpɒl.ɪ.neɪ.tər/ & an animal that transfers pollen between plants & côn trùng thụ phấn \\ \hline
\textbf{seed disperser} & & n phr & & an animal that spreads plant seeds across habitats | vật phát tán hạt giống \\ \hline
\textbf{carbon sequestration} & & n phr & & the process of capturing and storing atmospheric carbon dioxide | hấp thụ carbon \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{mortar} & n & /ˈmɔː.tər/ & a bowl-shaped tool used for grinding substances & cối xay, cối giã \\ \hline
\textbf{equanimity} & n & /ˌek.wəˈnɪm.ɪ.ti/ & mental calmness in the face of difficulty & sự bình thản, bình tĩnh \\ \hline
\textbf{redundant} & adj & /rɪˈdʌn.dənt/ & no longer needed or useful & thừa, không còn cần thiết \\ \hline
\textbf{self-flagellating} & adj & /ˌself.ˈflædʒ.ə.leɪ.tɪŋ/ & excessively punishing or criticising oneself & tự trách mình thái quá \\ \hline
\textbf{credibility} & n & /ˌkred.ɪˈbɪl.ɪ.ti/ & the quality of being trusted or believed & uy tín, sự đáng tin cậy \\ \hline
\textbf{salvage} & v & /ˈsæl.vɪdʒ/ & to save something from a damaging situation & vớt vát, cứu vãn \\ \hline
\textbf{articulate} & v & /ɑːˈtɪk.jʊ.leɪt/ & to express ideas clearly and effectively & diễn đạt rõ ràng \\ \hline
\textbf{ego security} & & n phr & & a stable sense of self that is not threatened by failure | sự vững vàng về bản thân \\ \hline
\textbf{transparent} & adj & /trænsˈpær.ənt/ & open and honest; easy to understand & minh bạch, thành thật \\ \hline
\textbf{fractured} & adj & /ˈfræk.tʃəd/ & broken or cracked & bị vỡ, nứt gãy \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{tacit knowledge} & & n phr & & knowledge that is difficult to transfer through words, learned through practice | tri thức âm tính/ngầm hiểu \\ \hline
\textbf{planned obsolescence} & & n phr & & designing products to fail or become unfashionable quickly | lỗi thời có kế hoạch \\ \hline
\textbf{repair cafe} & & n phr & & a community space where volunteers help repair broken items | quán sửa chữa cộng đồng \\ \hline
\textbf{intergenerational} & adj & /ˌɪn.tə.dʒen.əˈreɪ.ʃən.əl/ & relating to or involving people of different generations & liên thế hệ \\ \hline
\textbf{artisanal} & adj & /ɑːˈtɪz.ə.nəl/ & made in a traditional, skilled way using non-industrial methods & thủ công mỹ nghệ \\ \hline
\textbf{provenance} & n & /ˈprɒv.ɪ.nəns/ & the place of origin or history of an object & xuất xứ, nguồn gốc \\ \hline
\textbf{bespoke} & adj & /bɪˈspəʊk/ & made to order for a specific person; custom-built & đặt riêng, may đo riêng \\ \hline
\textbf{right-to-repair} & & n phr & & a policy movement giving consumers the right to repair their own devices | quyền được sửa chữa \\ \hline
\textbf{brittle} & adj & /ˈbrɪt.əl/ & hard but likely to break easily & giòn, dễ vỡ \\ \hline
\textbf{fungible} & adj & /ˈfʌn.dʒɪ.bəl/ & interchangeable; replaceable by another identical item & có thể thay thế lẫn nhau \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{ledger} & n & /ˈledʒ.ər/ & a book for recording financial transactions & sổ cái, sổ kế toán \\ \hline
\textbf{calligraphic} & adj & /ˌkæl.ɪˈɡræf.ɪk/ & relating to artistic, decorative handwriting & thuộc thư pháp \\ \hline
\textbf{ochre} & n/adj & /ˈəʊ.kər/ & a yellowish-brown colour; an earthy pigment & màu vàng nâu đất \\ \hline
\textbf{transcribe} & v & /trænˈskraɪb/ & to put written or spoken material into another form & sao chép, chép lại (văn bản) \\ \hline
\textbf{cohesion} & n & /kəʊˈhiː.ʒən/ & the quality of forming a unified whole & sự gắn kết \\ \hline
\textbf{attire} & n & /əˈtaɪər/ & clothing, especially formal or distinctive clothing & trang phục (thường trang trọng) \\ \hline
\textbf{material trace} & & n phr & & a physical object that serves as evidence of past existence | dấu vết vật chất \\ \hline
\textbf{relocation} & n & /ˌriː.ləʊˈkeɪ.ʃən/ & the act of moving from one place to another & sự di chuyển, tái định cư \\ \hline
\textbf{annotate} & v & /ˈæn.ə.teɪt/ & to add explanatory notes to a text or document & chú thích, ghi chú bổ sung \\ \hline
\textbf{anchor} & n/v & /ˈæŋ.kər/ & something that provides stability or a fixed point of reference & mỏ neo; điểm neo (ẩn dụ) \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{mnemonic} & adj/n & /nɪˈmɒn.ɪk/ & relating to memory or memory aids & ghi nhớ, thuộc trí nhớ \\ \hline
\textbf{haptic} & adj & /ˈhæp.tɪk/ & relating to the sense of touch & xúc giác \\ \hline
\textbf{ancestor veneration} & & n phr & & the cultural practice of honouring deceased relatives | thờ cúng tổ tiên \\ \hline
\textbf{artefact} & n & /ˈɑː.tɪ.fækt/ & an object made or modified by human beings, especially one of historical interest & hiện vật, đồ tạo tác \\ \hline
\textbf{curatorial} & adj & /ˌkjʊər.əˈtɔː.ri.əl/ & relating to the selection and organisation of a collection & thuộc quản lý bộ sưu tập \\ \hline
\textbf{repatriate} & v & /ˌriːˈpæt.ri.eɪt/ & to return cultural objects to their country of origin & hồi hương (hiện vật văn hoá) \\ \hline
\textbf{material culture} & & n phr & & the physical objects and artefacts that characterise a society | văn hoá vật chất \\ \hline
\textbf{reflexive} & adj & /rɪˈflek.sɪv/ & characterised by reflection on one's own processes & phản tư, tự nhận thức \\ \hline
\textbf{episodic memory} & & n phr & & memory of specific personal events and experiences | trí nhớ sự kiện (ký ức cụ thể) \\ \hline
\textbf{keepsake} & n & /ˈkiːp.seɪk/ & a small object kept as a reminder of a person or event & vật kỷ niệm \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{intellectual temperament} & & n phr & & one's characteristic style of thinking and engaging with ideas | tính khí trí tuệ \\ \hline
\textbf{relying on judgment} & & v phr & & trusting another person's reasoning in a decision | dựa vào sự phán đoán của ai \\ \hline
\textbf{mutual improvement} & & n phr & & a two-way process of helping each other develop | cải tiến lẫn nhau \\ \hline
\textbf{forthright} & adj & /ˈfɔːθ.raɪt/ & direct and outspoken, especially about difficult truths & thẳng thắn, dám nói thật \\ \hline
\textbf{integrity} & n & /ɪnˈteɡ.rɪ.ti/ & the quality of being honest and having strong moral principles & chính trực \\ \hline
\textbf{solidarity} & n & /ˌsɒl.ɪˈdær.ɪ.ti/ & unity and support within a group & sự đoàn kết \\ \hline
\textbf{reinforce} & v & /ˌriː.ɪnˈfɔːs/ & to strengthen or support an existing idea & củng cố, tăng cường \\ \hline
\textbf{practical wisdom} & & n phr & & the ability to make sound decisions in complex real-world situations | trí tuệ thực hành \\ \hline
\textbf{vulnerable} & adj & /ˈvʌl.nər.ə.bəl/ & open to emotional harm or in need of support & dễ tổn thương \\ \hline
\textbf{invested in} & & adj phr & & genuinely interested in and committed to someone's wellbeing | quan tâm thật sự đến \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{dyadic} & adj & /daɪˈæd.ɪk/ & relating to a pair or two-person relationship & thuộc quan hệ đôi (hai người) \\ \hline
\textbf{ascribed} & adj & /əˈskraɪbd/ & assigned based on birth or social category, not earned & được gán theo (xuất thân, không phải nỗ lực) \\ \hline
\textbf{voluntary affinity} & & n phr & & a connection chosen freely rather than assigned by circumstance | sự gắn kết tự nguyện \\ \hline
\textbf{candour} & n & /ˈkæn.dər/ & the quality of being open, frank, and honest & sự thẳng thắn, thành thật \\ \hline
\textbf{power differential} & & n phr & & an imbalance of authority between two people | chênh lệch quyền lực \\ \hline
\textbf{inhibition} & n & /ˌɪn.hɪˈbɪʃ.ən/ & a feeling that prevents free or natural expression & sự ức chế, sự kiềm chế bản thân \\ \hline
\textbf{circumvent} & v & /ˌsɜː.kəmˈvent/ & to find a way around a rule or difficulty & lách qua, né tránh \\ \hline
\textbf{adversarial bonding} & & n phr & & the forming of strong bonds through shared challenges | gắn kết qua thử thách, nghịch cảnh \\ \hline
\textbf{peer} & n & /pɪər/ & a person of the same rank, status, or age group & người ngang hàng \\ \hline
\textbf{horizontal relationship} & & n phr & & a relationship between equals, without hierarchy | quan hệ ngang hàng \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{conservatoire} & n & /kənˈsɜː.və.twɑːr/ & a school specialising in music or other arts & nhạc viện \\ \hline
\textbf{recital} & n & /rɪˈsaɪ.təl/ & a solo or small-group musical performance & buổi biểu diễn độc tấu/đơn ca \\ \hline
\textbf{repertoire} & n & /ˈrep.ə.twɑːr/ & the range of music a performer is able to play or sing & tiết mục biểu diễn \\ \hline
\textbf{nhạc trữ tình} & & n phr & & Vietnamese lyrical music, often with romantic or nostalgic themes | nhạc trữ tình (Việt Nam) \\ \hline
\textbf{acoustic} & adj & /əˈkuːs.tɪk/ & relating to natural, non-amplified sound & âm thanh tự nhiên (không khuếch âm) \\ \hline
\textbf{focal engagement} & & n phr & & concentrated, undivided attention directed at one thing | sự tập trung cao độ \\ \hline
\textbf{inhabited} & adj & /ɪnˈhæb.ɪ.tɪd/ & (of a performance) deeply felt and fully lived from the inside & (diễn xuất) hoá thân thật sự \\ \hline
\textbf{incidental} & adj & /ˌɪn.sɪˈden.tl/ & occurring by chance or as a minor accompaniment & tình cờ, thứ yếu \\ \hline
\textbf{semi-professional} & & adj & & performing to a high standard but not as a primary occupation | bán chuyên nghiệp \\ \hline
\textbf{disproportionate} & adj & /ˌdɪs.prəˈpɔː.ʃən.ət/ & larger or greater than expected in proportion & không cân xứng, quá mức tương ứng \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{reminiscence bump} & & n phr & & the tendency to vividly remember music/events from ages 15–25 | đỉnh hoài niệm (hiệu ứng tâm lý) \\ \hline
\textbf{formative period} & & n phr & & the developmental stage most important for shaping identity | giai đoạn hình thành (nhân cách) \\ \hline
\textbf{algorithmic recommendation} & & n phr & & automated suggestions based on user data and patterns | gợi ý thuật toán \\ \hline
\textbf{subculture} & n & /ˈsʌb.kʌl.tʃər/ & a group with shared values and practices within a larger culture & tiểu văn hoá \\ \hline
\textbf{public goods} & & n phr & & resources available to all and not diminished by use | hàng hoá công cộng \\ \hline
\textbf{age-gating} & & n phr & & restricting content access based on the user's age | rào cản độ tuổi \\ \hline
\textbf{ensemble} & n & /ɒnˈsɒm.bəl/ & a group performing music together & nhóm nhạc, dàn nhạc \\ \hline
\textbf{phonological processing} & & n phr & & the ability to perceive and manipulate sound units in language | xử lý ngữ âm \\ \hline
\textbf{soft power} & & n phr & & influence through culture and values rather than force | quyền lực mềm \\ \hline
\textbf{subsidy} & n & /ˈsʌb.sɪ.di/ & financial support given by government to help an activity or industry & trợ cấp, hỗ trợ tài chính \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{galangal} & n & /ˈɡæl.əŋ.ɡəl/ & a fragrant root related to ginger, used in Southeast Asian cooking & củ riềng \\ \hline
\textbf{foraged} & adj & /ˈfɒr.ɪdʒd/ & gathered from the wild rather than cultivated & hái/thu lượm từ tự nhiên \\ \hline
\textbf{debrief} & n/v & /ˌdiːˈbriːf/ & a meeting to review and discuss a completed event or project & họp tổng kết, báo cáo sau sự kiện \\ \hline
\textbf{hospitality} & n & /ˌhɒs.pɪˈtæl.ɪ.ti/ & the friendly and generous reception of guests & lòng hiếu khách \\ \hline
\textbf{register} & n & /ˈredʒ.ɪ.stər/ & the level of formality or tone used in a situation & phong cách (ngôn ngữ, giao tiếp) \\ \hline
\textbf{convergence} & n & /kənˈvɜː.dʒəns/ & the process of coming together & sự hội tụ \\ \hline
\textbf{set meal} & & n phr & & a fixed menu offered at a single price | bữa ăn theo suất cố định \\ \hline
\textbf{informality} & n & /ˌɪn.fɔːˈmæl.ɪ.ti/ & the quality of being relaxed and unceremonious & tính thân mật, không trang trọng \\ \hline
\textbf{commemorate} & v & /kəˈmem.ə.reɪt/ & to mark an event with a ceremony or celebration & kỷ niệm, tưởng niệm \\ \hline
\textbf{uncomplicated} & adj & /ˌʌnˈkɒm.plɪ.keɪ.tɪd/ & simple and free from difficulty & đơn giản, không phức tạp \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{communitas} & n & /kəˈmjuː.nɪ.tæs/ & the feeling of shared humanity and equality in a ritual setting & cộng đồng tình người (nhân học) \\ \hline
\textbf{ritual} & n & /ˈrɪtʃ.u.əl/ & a repeated symbolic practice with social or religious significance & nghi thức, lễ nghi \\ \hline
\textbf{self-disclosure} & & n phr & & voluntarily sharing personal information about oneself | tự tiết lộ thông tin cá nhân \\ \hline
\textbf{opportunity cost} & & n phr & & the value of the next-best alternative foregone | chi phí cơ hội \\ \hline
\textbf{dispersed} & adj & /dɪˈspɜːst/ & spread widely across different locations & phân tán, rải rác \\ \hline
\textbf{salient} & adj & /ˈseɪ.li.ənt/ & most noticeable or important & nổi bật, đáng chú ý \\ \hline
\textbf{nourishment} & n & /ˈnʌr.ɪʃ.mənt/ & food and drink necessary for health and growth & sự nuôi dưỡng \\ \hline
\textbf{primordial} & adj & /praɪˈmɔː.di.əl/ & existing from the very beginning; most ancient & nguyên thuỷ, cơ bản nhất \\ \hline
\textbf{debunk} & v & /ˌdiːˈbʌŋk/ & to expose the false claims of something widely believed & bác bỏ, vạch trần \\ \hline
\textbf{associative} & adj & /əˈsəʊ.si.ə.tɪv/ & characterised by free, topic-linked connections rather than rigid structure & liên tưởng, tự do \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{trajectory} & n & /trəˈdʒek.tər.i/ & the course of development of a career or life & quỹ đạo (sự nghiệp) \\ \hline
\textbf{consequential} & adj & /ˌkɒn.sɪˈkwen.ʃəl/ & important and having significant results & quan trọng, có hậu quả đáng kể \\ \hline
\textbf{second-guessing} & n & /ˌsek.əndˈɡes.ɪŋ/ & continuing to doubt a decision already made & nghi ngờ lại quyết định đã đưa ra \\ \hline
\textbf{in prospect} & & adv phr & & as something anticipated or imagined in advance | trong viễn cảnh, khi hình dung trước \\ \hline
\textbf{foresight} & n & /ˈfɔː.saɪt/ & the ability to predict what will happen and plan accordingly & tầm nhìn xa \\ \hline
\textbf{deliberate} & adj & /dɪˈlɪb.ər.ət/ & done consciously and intentionally & có chủ ý, thận trọng \\ \hline
\textbf{autonomous} & adj & /ɔːˈtɒn.ə.məs/ & making independent decisions without external control & tự chủ \\ \hline
\textbf{cognitive bias} & & n phr & & a systematic pattern of deviation from rational judgment | thiên kiến nhận thức \\ \hline
\textbf{confirmation bias} & & n phr & & the tendency to search for information that confirms existing beliefs | thiên kiến xác nhận \\ \hline
\textbf{resolve} & v & /rɪˈzɒlv/ & to settle or find a solution to a problem or decision & quyết định, giải quyết \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{epistemic humility} & & n phr & & recognition of the limits of one's own knowledge | sự khiêm tốn về nhận thức \\ \hline
\textbf{loss aversion} & & n phr & & the tendency to weigh potential losses more heavily than gains | ác cảm mất mát \\ \hline
\textbf{option-preservation} & & n phr & & the desire to keep choices open rather than commit | bảo toàn lựa chọn \\ \hline
\textbf{tendentiously} & adv & /tenˈden.ʃəs.li/ & in a way that promotes a particular cause or point of view & theo cách thiên lệch \\ \hline
\textbf{accountability anxiety} & & n phr & & fear of being blamed if a decision leads to a bad outcome | lo ngại trách nhiệm \\ \hline
\textbf{epistemic} & adj & /ˌep.ɪˈstem.ɪk/ & relating to knowledge and the conditions required for it & thuộc nhận thức luận \\ \hline
\textbf{discretionary} & adj & /dɪˈskreʃ.ən.er.i/ & left to personal choice and judgment & tuỳ ý, tự quyết \\ \hline
\textbf{endorse} & v & /ɪnˈdɔːs/ & to declare one's public approval or support & chứng thực, ủng hộ \\ \hline
\textbf{disentangle} & v & /ˌdɪs.ɪnˈtæŋ.ɡəl/ & to separate things that are confused or mixed together & gỡ rối, phân tách \\ \hline
\textbf{blind spot} & & n phr & & an area where one fails to see or understand | điểm mù (tư duy) \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{backup generator} & & n phr & & a device that provides power when the main electricity supply fails | máy phát điện dự phòng \\ \hline
\textbf{adversity} & n & /ədˈvɜː.sɪ.ti/ & a difficult or unpleasant situation & nghịch cảnh, khó khăn \\ \hline
\textbf{power outage} & & n phr & & a period when the electricity supply is cut off | mất điện (sự cố lưới điện) \\ \hline
\textbf{grid} & n & /ɡrɪd/ & the network of electricity supply lines & lưới điện \\ \hline
\textbf{surge} & n & /sɜːdʒ/ & a sudden powerful increase in electric current & tăng đột ngột điện áp \\ \hline
\textbf{constraint} & n & /kənˈstreɪnt/ & a limitation or restriction & ràng buộc, hạn chế \\ \hline
\textbf{diagnostic} & adj/n & /ˌdaɪ.əɡˈnɒs.tɪk/ & used to identify the nature of a problem & chẩn đoán, nhận biết \\ \hline
\textbf{cohesion} & n & /kəʊˈhiː.ʒən/ & the quality of working together effectively & sự gắn kết \\ \hline
\textbf{mobile data} & & n phr & & internet access through a cellular network | dữ liệu di động (mạng 4G/5G) \\ \hline
\textbf{escalate} & v & /ˈes.kə.leɪt/ & to become more serious or intense & leo thang, trở nên nghiêm trọng hơn \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{grid decarbonisation} & & n phr & & the process of reducing carbon emissions from electricity generation | phi carbon hoá lưới điện \\ \hline
\textbf{embodied carbon} & & n phr & & emissions produced in the manufacture of a product | carbon tích hợp (trong quá trình sản xuất) \\ \hline
\textbf{range anxiety} & & n phr & & fear of running out of battery before reaching a charger | lo lắng về phạm vi pin xe điện \\ \hline
\textbf{lifecycle emissions} & & n phr & & total emissions across a product's creation, use, and disposal | phát thải toàn vòng đời \\ \hline
\textbf{combustion engine} & & n phr & & an engine that generates power by burning fuel | động cơ đốt trong \\ \hline
\textbf{electrification} & n & /ɪˌlek.trɪ.fɪˈkeɪ.ʃən/ & the process of converting to electricity as a power source & điện khí hoá \\ \hline
\textbf{carbon intensity} & & n phr & & the amount of CO₂ emitted per unit of energy | cường độ carbon \\ \hline
\textbf{mandate} & n & /ˈmæn.deɪt/ & an official order or authority to do something & uỷ quyền, lệnh bắt buộc \\ \hline
\textbf{per-capita} & adj/adv & /ˌpɜː ˈkæp.ɪ.tə/ & calculated per person in a population & tính theo đầu người \\ \hline
\textbf{infrastructure} & n & /ˈɪn.frəˌstrʌk.tʃər/ & the basic systems needed for society to function & cơ sở hạ tầng \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{canyoning} & n & /ˈkæn.jən.ɪŋ/ & the sport of descending a canyon using multiple movement techniques & môn leo thác \\ \hline
\textbf{rappelling} & n & /ræˈpel.ɪŋ/ & descending a cliff face using a rope & kỹ thuật hạ dốc bằng dây \\ \hline
\textbf{kayaking} & n & /ˈkaɪ.æk.ɪŋ/ & paddling a small narrow boat using a double-bladed paddle & chèo thuyền kayak \\ \hline
\textbf{choppy} & adj & /ˈtʃɒp.i/ & (of water) with many small rough waves & (sóng) gồ ghề, lắc lư \\ \hline
\textbf{absorption} & n & /əbˈzɔːp.ʃən/ & complete concentration on an activity & sự đắm chìm, tập trung hoàn toàn \\ \hline
\textbf{adrenaline} & n & /əˈdren.ə.lɪn/ & a hormone released in exciting or dangerous situations & adrenaline (chất gây hưng phấn) \\ \hline
\textbf{momentum} & n & /məˈmen.təm/ & the force gained by a moving object & đà, lực quán tính \\ \hline
\textbf{opt out} & & v phr & & to choose not to participate in something | chọn không tham gia \\ \hline
\textbf{diffuse} & adj & /dɪˈfjuːs/ & spread over a wide area; not concentrated & lan toả, khuếch tán \\ \hline
\textbf{immersion} & n & /ɪˈmɜː.ʃən/ & deep involvement or absorption in an experience & sự đắm chìm, trải nghiệm toàn diện \\ \hline
\end{tabularx}
\end{center}
...
\textbf{Từ} & \textbf{Loại} & \textbf{IPA} & \textbf{English Meaning} & \textbf{Dịch nghĩa} \\
\hline
\textbf{hedonic adaptation} & & n phr & & the process by which people's happiness returns to a baseline after positive/negative events | thích nghi khoái lạc \\ \hline
\textbf{neurological plasticity} & & n phr & & the brain's ability to form new connections and change structure | tính linh hoạt thần kinh \\ \hline
\textbf{metacognition} & n & /ˌmet.əˌkɒɡˈnɪʃ.ən/ & thinking about one's own thinking processes & siêu nhận thức \\ \hline
\textbf{cognitive inertia} & & n phr & & the tendency to prefer familiar methods of thinking | quán tính nhận thức \\ \hline
\textbf{secondment} & n & /sɪˈkɒnd.mənt/ & a temporary transfer to another job or organisation & biệt phái ngắn hạn \\ \hline
\textbf{self-model} & & n phr & & a person's internal representation of their own abilities | mô hình tự nhận thức \\ \hline
\textbf{hedonic} & adj & /hɪˈdɒn.ɪk/ & relating to pleasure and the factors affecting wellbeing & thuộc về khoái lạc, hạnh phúc \\ \hline
\textbf{exhort} & v & /ɪɡˈzɔːt/ & to strongly encourage or urge someone to do something & thúc giục, khuyến khích mạnh \\ \hline
\textbf{novice} & n/adj & /ˈnɒv.ɪs/ & a person new to a skill or activity & người mới bắt đầu, tập sự \\ \hline
\textbf{attentional deployment} & & n phr & & the directing of conscious attention to specific stimuli | triển khai sự chú ý có ý thức \\ \hline
\end{tabularx}
\end{center}
