...
{The video of the dancing cat went viral and gained millions of views in just two days.}
{Đây là một tính từ dùng để chỉ việc lan truyền nhanh chóng trên mạng.}
...
\vocabentry{Source}
{/sɔːrs/ (n)}
{A person, publication, or other record or document that provides timely information.}
{Journalists must verify their sources to ensure the accuracy of their reports.}
{Đây là một danh từ dùng để chỉ nguồn tin.}
...
{The news program attracts millions of viewers every night.}
{Đây là một danh từ dùng để chỉ người xem truyền hình/video.}
...
{Wireless technology has made it possible to access news from anywhere at any time.}
