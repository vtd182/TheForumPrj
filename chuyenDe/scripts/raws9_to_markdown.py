...
def main() -> None:
    ap = argparse.ArgumentParser(description="Convert raws9 DOCX (Speaking) into Markdown for templates.")
    ap.add_argument("--in-dir", type=Path, default=Path("chuyenDe/LS/raw/raws9"))
    ap.add_argument("--out-dir", type=Path, default=Path("chuyenDe/LS/md/raws9"))
    args = ap.parse_args()
