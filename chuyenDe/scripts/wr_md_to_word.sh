...
# Regenerate Writing DOCX from Markdown files.
#
# Input layout:
#   chuyenDe/RW/md/<rawset>/Writing/Level<N>/W<week>.md
# Output layout:
#   chuyenDe/RW/docx/<rawset>/Writing/Level<N>/W<week>.docx
#
# Usage:
#   bash chuyenDe/scripts/wr_md_to_word.sh [md_root] [out_root]
#
# Examples:
...
md_root="${1:-${repo_root}/chuyenDe/RW/md/raww13}"
out_root="${2:-${repo_root}/chuyenDe/RW/docx/raww13}"
